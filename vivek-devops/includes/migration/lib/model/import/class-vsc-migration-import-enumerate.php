...
class VSC_Migration_Import_Enumerate {

	public static function execute( $params ) {

		// Set progress
		VSC_Migration_Status::info( __( 'Gathering WordPress files...', 'vivek-devops' ) );
		...
		// Set progress
		VSC_Migration_Status::info( __( 'WordPress files gathered.', 'vivek-devops' ) );
