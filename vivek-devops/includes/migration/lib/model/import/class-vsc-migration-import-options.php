...
class VSC_Migration_Import_Options {

	public static function execute( $params ) {
		// Set progress
		VSC_Migration_Status::info( __( 'Preparing WordPress options...', 'vivek-devops' ) );
		...
		// Get base prefix
		$base_prefix = vsc_migration_table_prefix();

		// Get mainsite prefix
		$mainsite_prefix = vsc_migration_table_prefix( 'mainsite' );
		...
		// Set progress
		VSC_Migration_Status::info( __( 'WordPress options prepared.', 'vivek-devops' ) );
