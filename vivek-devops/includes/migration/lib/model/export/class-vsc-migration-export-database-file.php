...
class VSC_Migration_Export_Database_File {
	...
	public static function execute( $params ) {
		...
		if ( isset( $params['total_database_size'] ) ) {
			...
			$total_database_size = vsc_migration_database_bytes( $params );
		}
		...
		VSC_Migration_Status::info( sprintf( __( 'Archiving database...<br />%d%% complete', 'vivek-devops' ), $progress ) );
		...
		if ( $archive->add_file( vsc_migration_database_path( $params ), VSC_MIGRATION_DATABASE_NAME, $database_bytes_written, $database_bytes_offset ) ) {

			// Set progress
			VSC_Migration_Status::info( __( 'Database archived.', 'vivek-devops' ) );
