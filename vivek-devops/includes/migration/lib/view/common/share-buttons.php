...
vsc_migration_enqueue_script(
	'vsc-migration-share-buttons-facebook',
	'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v9.0&appId=597242117012725'
);

vsc_migration_enqueue_script(
	'vsc-migration-share-buttons-youtube',
...
<div class="vsc-migration-share-button-container">
	<span>
		<a
			...
			<?php esc_html_e( 'Tweet', 'vivek-devops' ); ?>
		</a>
	</span>
	<span class="vsc-migration-top-positive-four">
		<div
			class="fb-like"
	...
	<span class="vsc-migration-top-positive-two">
