...
// = Plugin Debug =
// ================
define( 'VSC_MIGRATION_DEBUG', false );

// ==================
// = Plugin Version =
// ==================
define( 'VSC_MIGRATION_VERSION', '7.101' );

// ===============
// = Plugin Name =
// ===============
define( 'VSC_MIGRATION_PLUGIN_NAME', 'vivek-devops' );

// ================
// = Storage Path =
// ================
define( 'VSC_MIGRATION_STORAGE_PATH', VSC_MIGRATION_PATH . DIRECTORY_SEPARATOR . 'storage' );

// ==================
// = Error Log Path =
// ==================
define( 'VSC_MIGRATION_ERROR_FILE', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . 'error.log' );

// ===============
// = Status Path =
// ===============
define( 'VSC_MIGRATION_STATUS_FILE', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . 'status.js' );

// ============
// = Lib Path =
// ============
define( 'VSC_MIGRATION_LIB_PATH', VSC_MIGRATION_PATH . DIRECTORY_SEPARATOR . 'lib' );

// ===================
// = Controller Path =
// ===================
define( 'VSC_MIGRATION_CONTROLLER_PATH', VSC_MIGRATION_LIB_PATH . DIRECTORY_SEPARATOR . 'controller' );

// ==============
// = Model Path =
// ==============
define( 'VSC_MIGRATION_MODEL_PATH', VSC_MIGRATION_LIB_PATH . DIRECTORY_SEPARATOR . 'model' );

// =============
// = View Path =
// =============
define( 'VSC_MIGRATION_TEMPLATES_PATH', VSC_MIGRATION_LIB_PATH . DIRECTORY_SEPARATOR . 'view' );

// ===================
// = Set Bandar Path =
// ===================
define( 'BANDAR_TEMPLATES_PATH', VSC_MIGRATION_TEMPLATES_PATH );

// ===============
// = Vendor Path =
// ===============
define( 'VSC_MIGRATION_VENDOR_PATH', VSC_MIGRATION_LIB_PATH . DIRECTORY_SEPARATOR . 'vendor' );

// =========================
// = ServMask Feedback URL =
// =========================
define( 'VSC_MIGRATION_FEEDBACK_URL', 'https://servmask.com/ai1wm/feedback/create' );

// ==============================
// = ServMask Archive Tools URL =
// ==============================
define( 'VSC_MIGRATION_ARCHIVE_TOOLS_URL', 'https://servmask.com/archive/tools' );

// =========================
// = ServMask Table Prefix =
// =========================
define( 'VSC_MIGRATION_TABLE_PREFIX', 'SERVMASK_PREFIX_' );

// ========================
// = Archive Backups Name =
// ========================
define( 'VSC_MIGRATION_BACKUPS_NAME', 'vsc-migration-backups' );

// =========================
// = Archive Database Name =
// =========================
define( 'VSC_MIGRATION_DATABASE_NAME', 'database.sql' );

// ========================
// = Archive Package Name =
// ========================
define( 'VSC_MIGRATION_PACKAGE_NAME', 'package.json' );

// ==========================
// = Archive Multisite Name =
// ==========================
define( 'VSC_MIGRATION_MULTISITE_NAME', 'multisite.json' );

// ======================
// = Archive Blogs Name =
// ======================
define( 'VSC_MIGRATION_BLOGS_NAME', 'blogs.json' );

// =========================
// = Archive Settings Name =
// =========================
define( 'VSC_MIGRATION_SETTINGS_NAME', 'settings.json' );

// ==========================
// = Archive Multipart Name =
// ==========================
define( 'VSC_MIGRATION_MULTIPART_NAME', 'multipart.list' );

// =============================
// = Archive Content List Name =
// =============================
define( 'VSC_MIGRATION_CONTENT_LIST_NAME', 'content.list' );

// ===========================
// = Archive Media List Name =
// ===========================
define( 'VSC_MIGRATION_MEDIA_LIST_NAME', 'media.list' );

// =============================
// = Archive Plugins List Name =
// =============================
define( 'VSC_MIGRATION_PLUGINS_LIST_NAME', 'plugins.list' );

// ============================
// = Archive Themes List Name =
// ============================
define( 'VSC_MIGRATION_THEMES_LIST_NAME', 'themes.list' );

// ============================
// = Archive Tables List Name =
// ============================
define( 'VSC_MIGRATION_TABLES_LIST_NAME', 'tables.list' );

// =================================
// = Incremental Content List Name =
// =================================
define( 'VSC_MIGRATION_INCREMENTAL_CONTENT_LIST_NAME', 'incremental.content.list' );

// ===============================
// = Incremental Media List Name =
// ===============================
define( 'VSC_MIGRATION_INCREMENTAL_MEDIA_LIST_NAME', 'incremental.media.list' );

// =================================
// = Incremental Plugins List Name =
// =================================
define( 'VSC_MIGRATION_INCREMENTAL_PLUGINS_LIST_NAME', 'incremental.plugins.list' );

// ================================
// = Incremental Themes List Name =
// ================================
define( 'VSC_MIGRATION_INCREMENTAL_THEMES_LIST_NAME', 'incremental.themes.list' );

// =================================
// = Incremental Backups List Name =
// =================================
define( 'VSC_MIGRATION_INCREMENTAL_BACKUPS_LIST_NAME', 'incremental.backups.list' );

// =============================
// = Archive Cookies Text Name =
// =============================
define( 'VSC_MIGRATION_COOKIES_NAME', 'cookies.txt' );

// =================================
// = Archive Must-Use Plugins Name =
// =================================
define( 'VSC_MIGRATION_MUPLUGINS_NAME', 'mu-plugins' );

// ========================
// = Less Cache Extension =
// ========================
define( 'VSC_MIGRATION_LESS_CACHE_EXTENSION', '.less.cache' );

// =============================
// = SQLite Database Extension =
// =============================
define( 'VSC_MIGRATION_SQLITE_DATABASE_EXTENSION', '.sqlite' );

// ============================
// = Elementor CSS Cache Name =
// ============================
define( 'VSC_MIGRATION_ELEMENTOR_CSS_NAME', 'uploads' . DIRECTORY_SEPARATOR . 'elementor' . DIRECTORY_SEPARATOR . 'css' );

// ========================
// = CiviCRM Uploads Name =
// ========================
define( 'VSC_MIGRATION_CIVICRM_UPLOADS_NAME', 'uploads' . DIRECTORY_SEPARATOR . 'civicrm' );

// =========================
// = Themes Functions Name =
// =========================
define( 'VSC_MIGRATION_THEMES_FUNCTIONS_NAME', 'themes' . DIRECTORY_SEPARATOR . 'functions.php' );

// =============================
// = Endurance Page Cache Name =
// =============================
define( 'VSC_MIGRATION_ENDURANCE_PAGE_CACHE_NAME', 'endurance-page-cache.php' );

// ===========================
// = Endurance PHP Edge Name =
// ===========================
define( 'VSC_MIGRATION_ENDURANCE_PHP_EDGE_NAME', 'endurance-php-edge.php' );

// ================================
// = Endurance Browser Cache Name =
// ================================
define( 'VSC_MIGRATION_ENDURANCE_BROWSER_CACHE_NAME', 'endurance-browser-cache.php' );

// =========================
// = GD System Plugin Name =
// =========================
define( 'VSC_MIGRATION_GD_SYSTEM_PLUGIN_NAME', 'gd-system-plugin.php' );

// =======================
// = WP Stack Cache Name =
// =======================
define( 'VSC_MIGRATION_WP_STACK_CACHE_NAME', 'wp-stack-cache.php' );

// ===========================
// = WP.com Site Loader Name =
// ===========================
define( 'VSC_MIGRATION_WP_COMSH_LOADER_NAME', 'wpcomsh-loader.php' );

// ===========================
// = WP.com Site Helper Name =
// ===========================
define( 'VSC_MIGRATION_WP_COMSH_HELPER_NAME', 'wpcomsh' );

// ====================================
// = SQLite Database Integration Name =
// ====================================
define( 'VSC_MIGRATION_SQLITE_DATABASE_INTEGRATION_NAME', 'sqlite-database-integration' );

// =============================
// = SQLite Database Zero Name =
// =============================
define( 'VSC_MIGRATION_SQLITE_DATABASE_ZERO_NAME', '0-sqlite.php' );

// ================================
// = WP Engine System Plugin Name =
// ================================
define( 'VSC_MIGRATION_WP_ENGINE_SYSTEM_PLUGIN_NAME', 'mu-plugin.php' );

// ===========================
// = WPE Sign On Plugin Name =
// ===========================
define( 'VSC_MIGRATION_WPE_SIGN_ON_PLUGIN_NAME', 'wpe-wp-sign-on-plugin.php' );

// ===================================
// = WP Engine Security Auditor Name =
// ===================================
define( 'VSC_MIGRATION_WP_ENGINE_SECURITY_AUDITOR_NAME', 'wpengine-security-auditor.php' );

// ===========================
// = WP Cerber Security Name =
// ===========================
define( 'VSC_MIGRATION_WP_CERBER_SECURITY_NAME', 'aaa-wp-cerber.php' );

// ===============================
// = W3TC config file to exclude =
// ===============================
define( 'VSC_MIGRATION_W3TC_CONFIG_FILE', 'w3tc-config' . DIRECTORY_SEPARATOR . 'master.php' );

// ==================
// = Error Log Name =
// ==================
define( 'VSC_MIGRATION_ERROR_NAME', 'error-log-%s.log' );

// ==============
// = Secret Key =
// ==============
define( 'VSC_MIGRATION_SECRET_KEY', 'vsc_migration_secret_key' );

// =============
// = Auth User =
// =============
define( 'VSC_MIGRATION_AUTH_USER', 'vsc_migration_auth_user' );

// =================
// = Auth Password =
// =================
define( 'VSC_MIGRATION_AUTH_PASSWORD', 'vsc_migration_auth_password' );

// ===============
// = Auth Header =
// ===============
define( 'VSC_MIGRATION_AUTH_HEADER', 'vsc_migration_auth_header' );

// ============
// = Site URL =
// ============
define( 'VSC_MIGRATION_SITE_URL', 'siteurl' );

// ============
// = Home URL =
// ============
define( 'VSC_MIGRATION_HOME_URL', 'home' );

// ================
// = Uploads Path =
// ================
define( 'VSC_MIGRATION_UPLOADS_PATH', 'upload_path' );

// ====================
// = Uploads URL Path =
// ====================
define( 'VSC_MIGRATION_UPLOADS_URL_PATH', 'upload_url_path' );

// ==================
// = Active Plugins =
// ==================
define( 'VSC_MIGRATION_ACTIVE_PLUGINS', 'active_plugins' );

// ===========================
// = Active Sitewide Plugins =
// ===========================
define( 'VSC_MIGRATION_ACTIVE_SITEWIDE_PLUGINS', 'active_sitewide_plugins' );

// ==========================
// = Jetpack Active Modules =
// ==========================
define( 'VSC_MIGRATION_JETPACK_ACTIVE_MODULES', 'jetpack_active_modules' );

// ====================================
// = Swift Optimizer Plugin Organizer =
// ====================================
define( 'VSC_MIGRATION_SWIFT_OPTIMIZER_PLUGIN_ORGANIZER', 'swift_performance_plugin_organizer' );

// ======================
// = MS Files Rewriting =
// ======================
define( 'VSC_MIGRATION_MS_FILES_REWRITING', 'ms_files_rewriting' );

// ===================
// = Active Template =
// ===================
define( 'VSC_MIGRATION_ACTIVE_TEMPLATE', 'template' );

// =====================
// = Active Stylesheet =
// =====================
define( 'VSC_MIGRATION_ACTIVE_STYLESHEET', 'stylesheet' );

// ==============
// = DB Version =
// ==============
define( 'VSC_MIGRATION_DB_VERSION', 'db_version' );

// ======================
// = Initial DB Version =
// ======================
define( 'VSC_MIGRATION_INITIAL_DB_VERSION', 'initial_db_version' );

// ============
// = Cron Key =
// ============
define( 'VSC_MIGRATION_CRON', 'cron' );

// =======================
// = Backups Path Option =
// =======================
define( 'VSC_MIGRATION_BACKUPS_PATH_OPTION', 'vsc_migration_backups_path' );

// ===================
// = Backups Labels  =
// ===================
define( 'VSC_MIGRATION_BACKUPS_LABELS', 'vsc_migration_backups_labels' );

// ===============
// = Sites Links =
// ===============
define( 'VSC_MIGRATION_SITES_LINKS', 'vsc_migration_sites_links' );

// ==============================
// = Last Check For Updates Key =
// ==============================
define( 'VSC_MIGRATION_LAST_CHECK_FOR_UPDATES', 'vsc_migration_last_check_for_updates' );

// ===============
// = Updater Key =
// ===============
define( 'VSC_MIGRATION_UPDATER', 'vsc_migration_updater' );

// ==============
// = Status Key =
// ==============
define( 'VSC_MIGRATION_STATUS', 'vsc_migration_status' );

// ================
// = Messages Key =
// ================
define( 'VSC_MIGRATION_MESSAGES', 'vsc_migration_messages' );

// =================
// = Support Email =
// =================
define( 'VSC_MIGRATION_SUPPORT_EMAIL', 'support@servmask.com' );

// ==================
// = Max Chunk Size =
// ==================
define( 'VSC_MIGRATION_MAX_CHUNK_SIZE', 5 * 1024 * 1024 );

// =====================
// = Max Chunk Retries =
// =====================
define( 'VSC_MIGRATION_MAX_CHUNK_RETRIES', 10 );

// ===============
// = CIPHER NAME =
// ===============
define( 'VSC_MIGRATION_CIPHER_NAME', 'AES-256-CBC' );

// =============
// = SIGN TEXT =
// =============
define( 'VSC_MIGRATION_SIGN_TEXT', '"How long do you want these messages to remain secret? I want them to remain secret for as long as men are capable of evil." - Neal Stephenson' );

// ===========================
// = Max Transaction Queries =
// ===========================
if ( ! defined( 'VSC_MIGRATION_MAX_TRANSACTION_QUERIES' ) ) {
	define( 'VSC_MIGRATION_MAX_TRANSACTION_QUERIES', 1000 );
}

// ======================
// = Max Select Records =
// ======================
if ( ! defined( 'VSC_MIGRATION_MAX_SELECT_RECORDS' ) ) {
	define( 'VSC_MIGRATION_MAX_SELECT_RECORDS', 1000 );
}

// =======================
// = Max Storage Cleanup =
// =======================
define( 'VSC_MIGRATION_MAX_STORAGE_CLEANUP', 24 * 60 * 60 );

// ===================
// = Max Log Cleanup =
// ===================
define( 'VSC_MIGRATION_MAX_LOG_CLEANUP', 7 * 24 * 60 * 60 );

// =====================
// = Disk Space Factor =
// =====================
define( 'VSC_MIGRATION_DISK_SPACE_FACTOR', 2 );

// ====================
// = Disk Space Extra =
//=====================
define( 'VSC_MIGRATION_DISK_SPACE_EXTRA', 300 * 1024 * 1024 );
...
// ========================
if ( ! defined( 'VSC_MIGRATION_DEFAULT_BACKUPS_PATH' ) ) {
	define( 'VSC_MIGRATION_DEFAULT_BACKUPS_PATH', WP_CONTENT_DIR . DIRECTORY_SEPARATOR . 'vsc-migration-backups' );
}

// ================
// = Backups Path =
// ================
define( 'VSC_MIGRATION_BACKUPS_PATH', get_option( VSC_MIGRATION_BACKUPS_PATH_OPTION, VSC_MIGRATION_DEFAULT_BACKUPS_PATH ) );

// ==========================
// = Storage index.php File =
// ==========================
define( 'VSC_MIGRATION_STORAGE_INDEX_PHP', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . 'index.php' );

// ===========================
// = Storage index.html File =
// ===========================
define( 'VSC_MIGRATION_STORAGE_INDEX_HTML', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . 'index.html' );

// ==========================
// = Storage .htaccess File =
// ==========================
define( 'VSC_MIGRATION_STORAGE_HTACCESS', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . '.htaccess' );

// ===========================
// = Storage web.config File =
// ===========================
define( 'VSC_MIGRATION_STORAGE_WEBCONFIG', VSC_MIGRATION_STORAGE_PATH . DIRECTORY_SEPARATOR . 'web.config' );

// ==========================
// = Backups index.php File =
// ==========================
define( 'VSC_MIGRATION_BACKUPS_INDEX_PHP', VSC_MIGRATION_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'index.php' );

// ===========================
// = Backups index.html File =
// ===========================
define( 'VSC_MIGRATION_BACKUPS_INDEX_HTML', VSC_MIGRATION_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'index.html' );

// ===========================
// = Backups robots.txt File =
// ===========================
define( 'VSC_MIGRATION_BACKUPS_ROBOTS_TXT', VSC_MIGRATION_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'robots.txt' );

// ==========================
// = Backups .htaccess File =
// ==========================
define( 'VSC_MIGRATION_BACKUPS_HTACCESS', VSC_MIGRATION_BACKUPS_PATH . DIRECTORY_SEPARATOR . '.htaccess' );

// ===========================
// = Backups web.config File =
// ===========================
define( 'VSC_MIGRATION_BACKUPS_WEBCONFIG', VSC_MIGRATION_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'web.config' );

// ============================
// = WordPress .htaccess File =
// ============================
define( 'VSC_MIGRATION_WORDPRESS_HTACCESS', ABSPATH . DIRECTORY_SEPARATOR . '.htaccess' );

// =============================
// = WordPress web.config File =
// =============================
define( 'VSC_MIGRATION_WORDPRESS_WEBCONFIG', ABSPATH . DIRECTORY_SEPARATOR . 'web.config' );

// ================================
// = WP Migration Plugin Base Dir =
// ================================
if ( defined( 'VSC_MIGRATION_PLUGIN_BASENAME' ) ) {
	define( 'VSC_MIGRATION_PLUGIN_BASEDIR', dirname( VSC_MIGRATION_PLUGIN_BASENAME ) );
} else {
	define( 'VSC_MIGRATION_PLUGIN_BASEDIR', 'vivek-devops' );
}
...
if ( defined( 'AI1WMZE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMZE_PLUGIN_BASEDIR', 'vivek-devops-migration-azure-storage-extension' );
}
...
if ( defined( 'AI1WMAE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMAE_PLUGIN_BASEDIR', 'vivek-devops-migration-b2-extension' );
}
...
if ( defined( 'AI1WMVE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMVE_PLUGIN_BASEDIR', 'vivek-devops-migration-backup' );
}
...
if ( defined( 'AI1WMBE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMBE_PLUGIN_BASEDIR', 'vivek-devops-migration-box-extension' );
}
...
if ( defined( 'AI1WMIE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMIE_PLUGIN_BASEDIR', 'vivek-devops-migration-digitalocean-extension' );
}
...
if ( defined( 'AI1WMXE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMXE_PLUGIN_BASEDIR', 'vivek-devops-migration-direct-extension' );
}
// ==========================
...
if ( defined( 'AI1WMDE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMDE_PLUGIN_BASEDIR', 'vivek-devops-migration-dropbox-extension' );
}
...
if ( defined( 'AI1WMTE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMTE_PLUGIN_BASEDIR', 'vivek-devops-migration-file-extension' );
}
...
if ( defined( 'AI1WMFE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMFE_PLUGIN_BASEDIR', 'vivek-devops-migration-ftp-extension' );
}
...
if ( defined( 'AI1WMCE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMCE_PLUGIN_BASEDIR', 'vivek-devops-migration-gcloud-storage-extension' );
}
...
if ( defined( 'AI1WMGE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMGE_PLUGIN_BASEDIR', 'vivek-devops-migration-gdrive-extension' );
}
...
if ( defined( 'AI1WMRE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMRE_PLUGIN_BASEDIR', 'vivek-devops-migration-glacier-extension' );
}
...
if ( defined( 'AI1WMEE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMEE_PLUGIN_BASEDIR', 'vivek-devops-migration-mega-extension' );
}
...
if ( defined( 'AI1WMME_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMME_PLUGIN_BASEDIR', 'vivek-devops-migration-multisite-extension' );
}
...
if ( defined( 'AI1WMOE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMOE_PLUGIN_BASEDIR', 'vivek-devops-migration-onedrive-extension' );
}
...
if ( defined( 'AI1WMPE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMPE_PLUGIN_BASEDIR', 'vivek-devops-migration-pcloud-extension' );
}
...
if ( defined( 'AI1WMKE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMKE_PLUGIN_BASEDIR', 'vivek-devops-migration-pro' );
}
...
if ( ! defined( 'AI1WMKE_PLUGIN_ABOUT' ) ) {
	define( 'AI1WMKE_PLUGIN_ABOUT', 'https://plugin-updates.wp-migration.com/vivek-devops-migration-pro.json' );
}
...
if ( ! defined( 'AI1WMKE_PLUGIN_CHECK' ) ) {
	define( 'AI1WMKE_PLUGIN_CHECK', 'https://redirect.wp-migration.com/v1/check/vivek-devops-migration-pro' );
}
...
if ( defined( 'AI1WMNE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMNE_PLUGIN_BASEDIR', 'vivek-devops-migration-s3-client-extension' );
}
...
if ( defined( 'AI1WMSE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMSE_PLUGIN_BASEDIR', 'vivek-devops-migration-s3-extension' );
}
...
if ( defined( 'AI1WMUE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMUE_PLUGIN_BASEDIR', 'vivek-devops-migration-unlimited-extension' );
}
...
if ( defined( 'AI1WMLE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMLE_PLUGIN_BASEDIR', 'vivek-devops-migration-url-extension' );
}
...
if ( defined( 'AI1WMWE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMWE_PLUGIN_BASEDIR', 'vivek-devops-migration-webdav-extension' );
}
