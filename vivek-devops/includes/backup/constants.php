...
// = Error Log Path =
// ==================
if (!defined('VSC_BACKUP_ERROR_FILE')) {
	define( 'VSC_BACKUP_ERROR_FILE', VSC_BACKUP_STORAGE_PATH . DIRECTORY_SEPARATOR . 'error.log' );
}

// ===============
// = Status Path =
// ===============
if (!defined('VSC_BACKUP_STATUS_FILE')) {
	define( 'VSC_BACKUP_STATUS_FILE', VSC_BACKUP_STORAGE_PATH . DIRECTORY_SEPARATOR . 'status.js' );
}

// ===================
// = Controller Path =
// ===================
if (!defined('VSC_BACKUP_CONTROLLER_PATH')) {
	define( 'VSC_BACKUP_CONTROLLER_PATH', VSC_BACKUP_LIB_PATH . DIRECTORY_SEPARATOR . 'controller' );
}

// ==============
// = Model Path =
// ==============
if (!defined('VSC_BACKUP_MODEL_PATH')) {
	define( 'VSC_BACKUP_MODEL_PATH', VSC_BACKUP_LIB_PATH . DIRECTORY_SEPARATOR . 'model' );
}

// ===============
// = Export Path =
// ===============
if (!defined('VSC_BACKUP_EXPORT_PATH')) {
	define( 'VSC_BACKUP_EXPORT_PATH', VSC_BACKUP_MODEL_PATH . DIRECTORY_SEPARATOR . 'export' );
}

// ===============
// = Import Path =
// ===============
if (!defined('VSC_BACKUP_IMPORT_PATH')) {
	define( 'VSC_BACKUP_IMPORT_PATH', VSC_BACKUP_MODEL_PATH . DIRECTORY_SEPARATOR . 'import' );
}

// =============
// = View Path =
// =============
if (!defined('VSC_BACKUP_TEMPLATES_PATH')) {
	define( 'VSC_BACKUP_TEMPLATES_PATH', VSC_BACKUP_LIB_PATH . DIRECTORY_SEPARATOR . 'view' );
}
...
if (!defined('BANDAR_TEMPLATES_PATH')) {
	define( 'BANDAR_TEMPLATES_PATH', VSC_BACKUP_TEMPLATES_PATH );
}

// ===============
// = Vendor Path =
// ===============
if (!defined('VSC_BACKUP_VENDOR_PATH')) {
	define( 'VSC_BACKUP_VENDOR_PATH', VSC_BACKUP_LIB_PATH . DIRECTORY_SEPARATOR . 'vendor' );
}

// =========================
// = ServMask Feedback URL =
// =========================
define( 'VSC_BACKUP_FEEDBACK_URL', 'https://vivekchhikara.com/ai1wm/feedback/create' );

// ==============================
// = ServMask Archive Tools URL =
// ==============================
define( 'VSC_BACKUP_ARCHIVE_TOOLS_URL', 'https://vivekchhikara.com/archive/tools' );
...
// ========================
define( 'VSC_BACKUP_BACKUPS_NAME', 'ai1wm-backups' );
...
// ==========================
define( 'VSC_BACKUP_MULTISITE_NAME', 'multisite.json' );

// ======================
// = Archive Blogs Name =
// ======================
define( 'VSC_BACKUP_BLOGS_NAME', 'blogs.json' );
...
// ==========================
define( 'VSC_BACKUP_MULTIPART_NAME', 'multipart.list' );

// =============================
// = Archive Content List Name =
// =============================
define( 'VSC_BACKUP_CONTENT_LIST_NAME', 'content.list' );

// ===========================
// = Archive Media List Name =
// ===========================
define( 'VSC_BACKUP_MEDIA_LIST_NAME', 'media.list' );

// =============================
// = Archive Plugins List Name =
// =============================
define( 'VSC_BACKUP_PLUGINS_LIST_NAME', 'plugins.list' );

// ============================
// = Archive Themes List Name =
// ============================
define( 'VSC_BACKUP_THEMES_LIST_NAME', 'themes.list' );

// ============================
// = Archive Tables List Name =
// ============================
define( 'VSC_BACKUP_TABLES_LIST_NAME', 'tables.list' );

// =================================
// = Incremental Content List Name =
// =================================
define( 'VSC_BACKUP_INCREMENTAL_CONTENT_LIST_NAME', 'incremental.content.list' );

// ===============================
// = Incremental Media List Name =
// ===============================
define( 'VSC_BACKUP_INCREMENTAL_MEDIA_LIST_NAME', 'incremental.media.list' );

// =================================
// = Incremental Plugins List Name =
// =================================
define( 'VSC_BACKUP_INCREMENTAL_PLUGINS_LIST_NAME', 'incremental.plugins.list' );

// ================================
// = Incremental Themes List Name =
// ================================
define( 'VSC_BACKUP_INCREMENTAL_THEMES_LIST_NAME', 'incremental.themes.list' );

// =================================
// = Incremental Backups List Name =
// =================================
define( 'VSC_BACKUP_INCREMENTAL_BACKUPS_LIST_NAME', 'incremental.backups.list' );

// =============================
// = Archive Cookies Text Name =
// =============================
define( 'VSC_BACKUP_COOKIES_NAME', 'cookies.txt' );

// =================================
// = Archive Must-Use Plugins Name =
// =================================
define( 'VSC_BACKUP_MUPLUGINS_NAME', 'mu-plugins' );

// =============================
// = Less Cache Extension Name =
// =============================
define( 'VSC_BACKUP_LESS_CACHE_NAME', '.less.cache' );

// ============================
// = Elementor CSS Cache Name =
// ============================
define( 'VSC_BACKUP_ELEMENTOR_CSS_NAME', 'uploads' . DIRECTORY_SEPARATOR . 'elementor' . DIRECTORY_SEPARATOR . 'css' );

// =========================
// = Themes Functions Name =
// =========================
define( 'VSC_BACKUP_THEMES_FUNCTIONS_NAME', 'themes' . DIRECTORY_SEPARATOR . 'functions.php' );

// =============================
// = Endurance Page Cache Name =
// =============================
define( 'VSC_BACKUP_ENDURANCE_PAGE_CACHE_NAME', 'endurance-page-cache.php' );

// ===========================
// = Endurance PHP Edge Name =
// ===========================
define( 'VSC_BACKUP_ENDURANCE_PHP_EDGE_NAME', 'endurance-php-edge.php' );

// ================================
// = Endurance Browser Cache Name =
// ================================
define( 'VSC_BACKUP_ENDURANCE_BROWSER_CACHE_NAME', 'endurance-browser-cache.php' );

// =========================
// = GD System Plugin Name =
// =========================
define( 'VSC_BACKUP_GD_SYSTEM_PLUGIN_NAME', 'gd-system-plugin.php' );

// =======================
// = WP Stack Cache Name =
// =======================
define( 'VSC_BACKUP_WP_STACK_CACHE_NAME', 'wp-stack-cache.php' );

// ===========================
// = WP.com Site Loader Name =
// ===========================
define( 'VSC_BACKUP_WP_COMSH_LOADER_NAME', 'wpcomsh-loader.php' );

// ===========================
// = WP.com Site Helper Name =
// ===========================
define( 'VSC_BACKUP_WP_COMSH_HELPER_NAME', 'wpcomsh' );

// ================================
// = WP Engine System Plugin Name =
// ================================
define( 'VSC_BACKUP_WP_ENGINE_SYSTEM_PLUGIN_NAME', 'mu-plugin.php' );

// ===========================
// = WPE Sign On Plugin Name =
// ===========================
define( 'VSC_BACKUP_WPE_SIGN_ON_PLUGIN_NAME', 'wpe-wp-sign-on-plugin.php' );

// ===================================
// = WP Engine Security Auditor Name =
// ===================================
define( 'VSC_BACKUP_WP_ENGINE_SECURITY_AUDITOR_NAME', 'wpengine-security-auditor.php' );

// ===========================
// = WP Cerber Security Name =
// ===========================
define( 'VSC_BACKUP_WP_CERBER_SECURITY_NAME', 'aaa-wp-cerber.php' );

// ==================
// = Error Log Name =
// ==================
define( 'VSC_BACKUP_ERROR_NAME', 'error.log' );
...
// = Auth User =
// =============
define( 'VSC_BACKUP_AUTH_USER', 'vsc_backup_auth_user' );

// =================
// = Auth Password =
// =================
define( 'VSC_BACKUP_AUTH_PASSWORD', 'vsc_backup_auth_password' );

// ============
// = Site URL =
// ============
define( 'VSC_BACKUP_SITE_URL', 'siteurl' );

// ============
// = Home URL =
// ============
define( 'VSC_BACKUP_HOME_URL', 'home' );

// ================
// = Uploads Path =
// ================
define( 'VSC_BACKUP_UPLOADS_PATH', 'upload_path' );

// ====================
// = Uploads URL Path =
// ====================
define( 'VSC_BACKUP_UPLOADS_URL_PATH', 'upload_url_path' );

// ==================
// = Active Plugins =
// ==================
define( 'VSC_BACKUP_ACTIVE_PLUGINS', 'active_plugins' );

// ===========================
// = Active Sitewide Plugins =
// ===========================
define( 'VSC_BACKUP_ACTIVE_SITEWIDE_PLUGINS', 'active_sitewide_plugins' );

// ==========================
// = Jetpack Active Modules =
// ==========================
define( 'VSC_BACKUP_JETPACK_ACTIVE_MODULES', 'jetpack_active_modules' );

// ====================================
// = Swift Optimizer Plugin Organizer =
// ====================================
define( 'VSC_BACKUP_SWIFT_OPTIMIZER_PLUGIN_ORGANIZER', 'swift_performance_plugin_organizer' );

// ======================
// = MS Files Rewriting =
// ======================
define( 'VSC_BACKUP_MS_FILES_REWRITING', 'ms_files_rewriting' );

// ===================
// = Active Template =
// ===================
define( 'VSC_BACKUP_ACTIVE_TEMPLATE', 'template' );

// =====================
// = Active Stylesheet =
// =====================
define( 'VSC_BACKUP_ACTIVE_STYLESHEET', 'stylesheet' );

// ==============
// = DB Version =
// ==============
define( 'VSC_BACKUP_DB_VERSION', 'db_version' );

// ======================
// = Initial DB Version =
// ======================
define( 'VSC_BACKUP_INITIAL_DB_VERSION', 'initial_db_version' );

// ============
// = Cron Key =
// ============
define( 'VSC_BACKUP_CRON', 'cron' );

// =======================
// = Backups Path Option =
// =======================
define( 'VSC_BACKUP_BACKUPS_PATH_OPTION', 'vsc_backup_backups_path' );

// ===================
// = Backups Labels  =
// ===================
define( 'VSC_BACKUP_BACKUPS_LABELS', 'vsc_backup_backups_labels' );

// ===============
// = Sites Links =
// ===============
define( 'VSC_BACKUP_SITES_LINKS', 'vsc_backup_sites_links' );

// ==============================
// = Last Check For Updates Key =
// ==============================
define( 'VSC_BACKUP_LAST_CHECK_FOR_UPDATES', 'vsc_backup_last_check_for_updates' );

// ===============
// = Updater Key =
// ===============
define( 'VSC_BACKUP_UPDATER', 'vsc_backup_updater' );

// ==============
// = Status Key =
// ==============
define( 'VSC_BACKUP_STATUS', 'vsc_backup_status' );

// ================
// = Messages Key =
// ================
define( 'VSC_BACKUP_MESSAGES', 'vsc_backup_messages' );

// =================
// = Support Email =
// =================
define( 'VSC_BACKUP_SUPPORT_EMAIL', 'support@vivekchhikara.com' );
...
// = Max Chunk Retries =
// =====================
define( 'VSC_BACKUP_MAX_CHUNK_RETRIES', 10 );

// ===============
// = CIPHER NAME =
// ===============
define( 'VSC_BACKUP_CIPHER_NAME', 'AES-256-CBC' );

// =============
// = SIGN TEXT =
// =============
define( 'VSC_BACKUP_SIGN_TEXT', '"How long do you want these messages to remain secret? I want them to remain secret for as long as men are capable of evil." - Neal Stephenson' );

// ===========================
// = Max Transaction Queries =
// ===========================
if ( ! defined( 'VSC_BACKUP_MAX_TRANSACTION_QUERIES' ) ) {
	define( 'VSC_BACKUP_MAX_TRANSACTION_QUERIES', 1000 );
}

// ======================
// = Max Select Records =
// ======================
if ( ! defined( 'VSC_BACKUP_MAX_SELECT_RECORDS' ) ) {
	define( 'VSC_BACKUP_MAX_SELECT_RECORDS', 1000 );
}

// =======================
// = Max Storage Cleanup =
// =======================
define( 'VSC_BACKUP_MAX_STORAGE_CLEANUP', 24 * 60 * 60 );

// =====================
// = Disk Space Factor =
// =====================
define( 'VSC_BACKUP_DISK_SPACE_FACTOR', 2 );

// ====================
// = Disk Space Extra =
//=====================
define( 'VSC_BACKUP_DISK_SPACE_EXTRA', 300 * 1024 * 1024 );
...
// ========================
if ( ! defined( 'VSC_BACKUP_DEFAULT_BACKUPS_PATH' ) ) {
	define( 'VSC_BACKUP_DEFAULT_BACKUPS_PATH', WP_CONTENT_DIR . DIRECTORY_SEPARATOR . 'ai1wm-backups' );
}
...
// ==========================
define( 'VSC_BACKUP_STORAGE_INDEX_PHP', VSC_BACKUP_STORAGE_PATH . DIRECTORY_SEPARATOR . 'index.php' );

// ===========================
// = Storage index.html File =
// ===========================
define( 'VSC_BACKUP_STORAGE_INDEX_HTML', VSC_BACKUP_STORAGE_PATH . DIRECTORY_SEPARATOR . 'index.html' );

// ==========================
// = Backups index.php File =
// ==========================
define( 'VSC_BACKUP_BACKUPS_INDEX_PHP', VSC_BACKUP_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'index.php' );

// ===========================
// = Backups index.html File =
// ===========================
define( 'VSC_BACKUP_BACKUPS_INDEX_HTML', VSC_BACKUP_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'index.html' );

// ===========================
// = Backups robots.txt File =
// ===========================
define( 'VSC_BACKUP_BACKUPS_ROBOTS_TXT', VSC_BACKUP_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'robots.txt' );

// ==========================
// = Backups .htaccess File =
// ==========================
define( 'VSC_BACKUP_BACKUPS_HTACCESS', VSC_BACKUP_BACKUPS_PATH . DIRECTORY_SEPARATOR . '.htaccess' );

// ===========================
// = Backups web.config File =
// ===========================
define( 'VSC_BACKUP_BACKUPS_WEBCONFIG', VSC_BACKUP_BACKUPS_PATH . DIRECTORY_SEPARATOR . 'web.config' );

// ============================
// = WordPress .htaccess File =
// ============================
define( 'VSC_BACKUP_WORDPRESS_HTACCESS', ABSPATH . DIRECTORY_SEPARATOR . '.htaccess' );

// =============================
// = WordPress web.config File =
// =============================
define( 'VSC_BACKUP_WORDPRESS_WEBCONFIG', ABSPATH . DIRECTORY_SEPARATOR . 'web.config' );
...
if ( defined( 'VSC_BACKUP_PLUGIN_BASENAME' ) ) {
	...
	define( 'VSC_BACKUP_PLUGIN_BASEDIR', 'vsc-backup' );
}
...
if ( defined( 'AI1WMZE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMZE_PLUGIN_BASEDIR', 'vsc-backup-azure-storage-extension' );
}
...
if ( defined( 'AI1WMAE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMAE_PLUGIN_BASEDIR', 'vsc-backup-b2-extension' );
}
...
if ( defined( 'AI1WMVE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMVE_PLUGIN_BASEDIR', 'vsc-backup-backup' );
}
...
if ( defined( 'AI1WMBE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMBE_PLUGIN_BASEDIR', 'vsc-backup-box-extension' );
}
...
if ( defined( 'AI1WMIE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMIE_PLUGIN_BASEDIR', 'vsc-backup-digitalocean-extension' );
}
...
if ( defined( 'AI1WMXE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMXE_PLUGIN_BASEDIR', 'vsc-backup-direct-extension' );
}
// ==========================
...
if ( defined( 'AI1WMDE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMDE_PLUGIN_BASEDIR', 'vsc-backup-dropbox-extension' );
}
...
if ( defined( 'AI1WMTE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMTE_PLUGIN_BASEDIR', 'vsc-backup-file-extension' );
}
...
if ( defined( 'AI1WMFE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMFE_PLUGIN_BASEDIR', 'vsc-backup-ftp-extension' );
}
...
if ( defined( 'AI1WMCE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMCE_PLUGIN_BASEDIR', 'vsc-backup-gcloud-storage-extension' );
}
...
if ( defined( 'AI1WMGE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMGE_PLUGIN_BASEDIR', 'vsc-backup-gdrive-extension' );
}
...
if ( defined( 'AI1WMRE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMRE_PLUGIN_BASEDIR', 'vsc-backup-glacier-extension' );
}
...
if ( defined( 'AI1WMEE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMEE_PLUGIN_BASEDIR', 'vsc-backup-mega-extension' );
}
...
if ( defined( 'AI1WMME_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMME_PLUGIN_BASEDIR', 'vsc-backup-multisite-extension' );
}
...
if ( defined( 'AI1WMOE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMOE_PLUGIN_BASEDIR', 'vsc-backup-onedrive-extension' );
}
...
if ( defined( 'AI1WMPE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMPE_PLUGIN_BASEDIR', 'vsc-backup-pcloud-extension' );
}
...
if ( defined( 'AI1WMKE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMKE_PLUGIN_BASEDIR', 'vsc-backup-pro' );
}
...
if ( defined( 'AI1WMNE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMNE_PLUGIN_BASEDIR', 'vsc-backup-s3-client-extension' );
}
...
if ( defined( 'AI1WMSE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMSE_PLUGIN_BASEDIR', 'vsc-backup-s3-extension' );
}
...
// =============================
if ( ! defined( 'VSC_BACKUP_PLUGIN_TITLE' ) ) {
	define( 'VSC_BACKUP_PLUGIN_TITLE', 'Unlimited Extension' );
}

// =============================
// = Unlimited Extension About =
// =============================
if ( ! defined( 'VSC_BACKUP_PLUGIN_ABOUT' ) ) {
	define( 'VSC_BACKUP_PLUGIN_ABOUT', 'https://plugin-updates.wp-migration.com/unlimited-extension.json' );
}

// =============================
// = Unlimited Extension Check =
// =============================
if ( ! defined( 'VSC_BACKUP_PLUGIN_CHECK' ) ) {
	define( 'VSC_BACKUP_PLUGIN_CHECK', 'https://redirect.wp-migration.com/v1/check/unlimited-extension' );
}

// ===========================
// = Unlimited Extension Key =
// ===========================
if ( ! defined( 'VSC_BACKUP_PLUGIN_KEY' ) ) {
	define( 'VSC_BACKUP_PLUGIN_KEY', 'vsc_backup_plugin_key' );
}

// =============================
// = Unlimited Extension Short =
// =============================
if ( ! defined( 'VSC_BACKUP_PLUGIN_SHORT' ) ) {
	define( 'VSC_BACKUP_PLUGIN_SHORT', 'unlimited' );
}
...
if ( defined( 'AI1WMLE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMLE_PLUGIN_BASEDIR', 'vsc-backup-url-extension' );
}
...
if ( defined( 'AI1WMWE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMWE_PLUGIN_BASEDIR', 'vsc-backup-webdav-extension' );
}
