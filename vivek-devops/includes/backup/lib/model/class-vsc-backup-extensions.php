...
class VSC_Backup_Extensions {
	...
	public static function get() {
		...
		if ( defined( 'VSC_BACKUP_PLUGIN_NAME' ) ) {
			$extensions[ VSC_BACKUP_PLUGIN_NAME ] = array(
				'key'      => VSC_BACKUP_PLUGIN_KEY,
				'title'    => VSC_BACKUP_PLUGIN_TITLE,
				'about'    => VSC_BACKUP_PLUGIN_ABOUT,
				'check'    => VSC_BACKUP_PLUGIN_CHECK,
				'basename' => VSC_BACKUP_PLUGIN_BASENAME,
				'version'  => VSC_BACKUP_VERSION,
				'requires' => '2.49',
				'short'    => VSC_BACKUP_PLUGIN_SHORT,
			);
		}
