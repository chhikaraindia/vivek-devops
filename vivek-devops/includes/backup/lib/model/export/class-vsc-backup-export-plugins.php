...
class VSC_Backup_Export_Plugins {
	...
	public static function execute( $params ) {
		...
		// Set progress
		VSC_Backup_Status::info( sprintf( __( 'Archiving %d plugin files...<br />%d%% complete', VSC_BACKUP_PLUGIN_NAME ), $total_plugins_files_count, $progress ) );
		...
		$plugins_list = vsc_backup_open( vsc_backup_plugins_list_path( $params ), 'r' );
