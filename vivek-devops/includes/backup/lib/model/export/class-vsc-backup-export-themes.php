...
class VSC_Backup_Export_Themes {
	...
	public static function execute( $params ) {
		...
		// Set progress
		VSC_Backup_Status::info( sprintf( __( 'Archiving %d theme files...<br />%d%% complete', VSC_BACKUP_PLUGIN_NAME ), $total_themes_files_count, $progress ) );
		...
		$themes_list = vsc_backup_open( vsc_backup_themes_list_path( $params ), 'r' );
