...
class VSC_Backup_Export_Content {
	...
	public static function execute( $params ) {
		...
		// Set progress
		VSC_Backup_Status::info( sprintf( __( 'Archiving %d content files...<br />%d%% complete', VSC_BACKUP_PLUGIN_NAME ), $total_content_files_count, $progress ) );
		...
		$content_list = vsc_backup_open( vsc_backup_content_list_path( $params ), 'r' );
