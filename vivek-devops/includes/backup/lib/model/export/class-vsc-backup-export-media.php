...
class VSC_Backup_Export_Media {
	...
	public static function execute( $params ) {
		...
		// Set progress
		VSC_Backup_Status::info( sprintf( __( 'Archiving %d media files...<br />%d%% complete', VSC_BACKUP_PLUGIN_NAME ), $total_media_files_count, $progress ) );
		...
		// Get media list file
		$media_list = vsc_backup_open( vsc_backup_media_list_path( $params ), 'r' );
