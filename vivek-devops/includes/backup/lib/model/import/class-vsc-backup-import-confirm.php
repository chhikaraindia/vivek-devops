...
class VSC_Backup_Import_Confirm {
	...
	public static function execute( $params ) {
			...
			switch ( true ) {
				case ( version_compare( $package['PHP']['Version'], '7.0.0', '<' ) && version_compare( PHP_VERSION, '8.0.0', '>=' ) ):
					$php_version_message_cli = __(
						...
						'This could cause the import to fail. Technical details: https://help.vivekchhikara.com/knowledgebase/migrate-wordpress-from-php-5-to-php-7/',
						VSC_BACKUP_PLUGIN_NAME
					);
					$php_version_message     = __(
						...
						'This could cause the import to fail. <a href="https://help.vivekchhikara.com/knowledgebase/migrate-wordpress-from-php-5-to-php-7/" target="_blank">Technical details</a></i>',
						VSC_BACKUP_PLUGIN_NAME
					);
					break;
		...
		// Set progress
		VSC_Backup_Status::confirm( implode( $messages ) );
		exit;
	}
}
