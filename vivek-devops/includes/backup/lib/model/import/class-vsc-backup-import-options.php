...
class VSC_Backup_Import_Options {

	public static function execute( $params, VSC_Backup_Database $mysql = null ) {
		// Set progress
		VSC_Backup_Status::info( __( 'Preparing options...', VSC_BACKUP_PLUGIN_NAME ) );
		...
		// Get base prefix
		$base_prefix = vsc_backup_table_prefix();

		// Get mainsite prefix
		$mainsite_prefix = vsc_backup_table_prefix( 'mainsite' );
		...
		// Set progress
		VSC_Backup_Status::info( __( 'Done preparing options.', VSC_BACKUP_PLUGIN_NAME ) );
