/******/ (function () {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 874: /***/ function (
      ...
      var Restore = function Restore() {
        ...
        model.setStatus({
          type: "pro",
          message: vsc_backup_locale.restore_from_file,
        });
      };
    ...
    /***/ 12: /***/ function (
      ...
      Export.prototype.start = function (options, retries) {
        ...
        $(window).bind("beforeunload", function () {
          return vsc_backup_locale.stop_exporting_your_website;
        }); // Set initial status

        this.setStatus({
          type: "info",
          message: vsc_backup_locale.preparing_to_export,
        }); // Set params

        var params = this.params.concat({
          name: "secret_key",
          value: vsc_backup_export.secret_key,
        ...
        $.ajax({
          url: vsc_backup_export.ajax.url,
          type: "POST",
          dataType: "json",
          data: params,
          ...
          .fail(function (xhr) {
            ...
            try {
              ...
              if (json) {
                ...
                if (error.message) {
                  ...
                  self.setStatus({
                    type: "error",
                    title: vsc_backup_locale.unable_to_export,
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_export,
                message: vsc_backup_locale.unable_to_start_the_export,
              });
              return;
            }
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_export,
                message: vsc_backup_locale.unable_to_run_the_export,
              });
              return;
            }
      ...
      Export.prototype.clean = function (options, retries) {
        ...
        this.setStatus({
          type: "info",
          message: vsc_backup_locale.please_wait_stopping_the_export,
        }); // Set params
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_export,
                message: vsc_backup_locale.unable_to_stop_the_export,
              });
              return;
            }
      ...
      Export.prototype.getStatus = function () {
        ...
        this.statusXhr = $.ajax({
          url: vsc_backup_export.status.url,
          type: "GET",
          dataType: "json",
          cache: false,
          dataFilter: function dataFilter(data) {
    ...
    /***/ 326: /***/ function (module) {
      ...
      var Modal = function Modal() {
        ...
        this.error = function (params) {
          ...
          var title = $("<span></span>")
            .addClass("ai1wm-title-red")
            .text(params.title); // Create close button

          var closeButton = $(
            '<button type="button" class="ai1wm-button-red"></button>',
          ).on("click", function () {
            self.destroy();
          }); // Append text to close button

          closeButton.append(vsc_backup_locale.close_export); // Append close button to action
        ...
        this.download = function (params) {
          ...
          if (counter.text() > 1) {
            counter.prop(
              "title",
              vsc_backup_locale.backups_count_plural.replace("%d", counter.text()),
            );
          } else {
            counter.removeClass("ai1wm-menu-hide");
            counter.prop(
              "title",
              vsc_backup_locale.backups_count_singular.replace("%d", counter.text()),
            );
          } // Append text to close button
        ...
        this.modal = $(
          '<div class="ai1wm-modal-container" role="dialog" tabindex="-1"></div>',
        );
        $("body")
          .append(this.overlay) // Append overlay to body
    ...
    /***/ 936: /***/ function (
      ...
      Import.prototype.start = function (options, retries) {
        ...
        $(window).bind("beforeunload", function () {
          return vsc_backup_locale.stop_importing_your_website;
        }); // Set initial status

        this.setStatus({
          type: "info",
          message: vsc_backup_locale.preparing_to_import,
        }); // Set params

        var params = this.params.concat({
          name: "secret_key",
          value: vsc_backup_import.secret_key,
        }); // Set additional params
        ...
        $.ajax({
          url: vsc_backup_import.ajax.url,
          type: "POST",
          dataType: "json",
          data: params,
          dataFilter: function dataFilter(data) {
          ...
          .fail(function (xhr) {
            ...
            try {
              ...
              if (json) {
                ...
                if (error.message) {
                  ...
                  self.setStatus({
                    type: "error",
                    title: vsc_backup_locale.unable_to_import,
                    message: error.message,
                  });
                  return;
                }
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_import,
                message: vsc_backup_locale.unable_to_start_the_import,
              });
              return;
            }
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_import,
                message: vsc_backup_locale.unable_to_check_decryption_password,
              });
              return;
            }
            ...
            retries++;
            setTimeout(
              self.decryptPassword.bind(self, options, password, retries),
              timeout,
            );
          });
      };
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_import,
                message: vsc_backup_locale.unable_to_confirm_the_import,
              });
              return;
            }
      ...
      Import.prototype.checkDiskSpace = function (fileSize, callback) {
        ...
        var diskSpaceFree = parseInt(vsc_backup_disk_space.free, 10);
        var diskSpaceFactor = parseInt(vsc_backup_disk_space.factor, 10);
        var diskSpaceExtra = parseInt(vsc_backup_disk_space.extra, 10);
        ...
        if (diskSpaceFree >= 0) {
          ...
          if (diskSpaceRequired > diskSpaceFree) {
            this.setStatus({
              ...
              message: vsc_backup_locale.out_of_disk_space.replace(
                "%s",
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_import,
                message: vsc_backup_locale.unable_to_prepare_blogs_on_import,
              });
              return;
            }
      ...
      Import.prototype.clean = function (options, retries) {
        ...
        this.setStatus({
          type: "info",
          message: vsc_backup_locale.please_wait_stopping_the_import,
        }); // Set params
          ...
          .fail(function (xhr) {
            ...
            if (retries >= 5) {
              ...
              self.setStatus({
                type: "error",
                title: vsc_backup_locale.unable_to_import,
                message: vsc_backup_locale.unable_to_stop_the_import,
              });
              return;
            }
      ...
      Import.prototype.getStatus = function () {
        ...
        this.statusXhr = $.ajax({
          url: vsc_backup_import.status.url,
          type: "GET",
          dataType: "json",
          cache: false,
          dataFilter: function dataFilter(data) {
    ...
    /***/ 544: /***/ function (module) {
      ...
      var Modal = function Modal() {
        ...
        this.error = function (params) {
          ...
          closeButton.append(vsc_backup_locale.close_import); // Append close button to action
        ...
        this.progress = function (params) {
          ...
          this.progress.progressBarMeter = $(
            '<span class="ai1wm-progress-bar-meter"></span>',
          ).width(params.percent + "%"); // Create progress bar percent

          this.progress.progressBarPercent = $(
            '<span class="ai1wm-progress-bar-percent"></span>',
          ).text(params.percent + "%"); // Create stop import
          ...
          stopButton.append(
            '<i class="ai1wm-icon-notification"></i> ' +
              vsc_backup_locale.stop_import,
          ); // Append progress meter and progress percent

          progressBar
            .append(this.progress.progressBarMeter)
            .append(this.progress.progressBarPercent); // Append stop button to action
        ...
        this.pro = function (params) {
          ...
          var message = $('<p class="ai1wm-import-modal-content"></p>').html(
            params.message,
          ...
          var closeButton = $(
            '<button type="button" class="ai1wm-button-gray"></button>',
          ).on("click", function () {
            self.destroy();
          }); // Append text to close button
        ...
        this.confirm = function (params) {
          ...
          var confirmButton = $(
            '<button type="button" class="ai1wm-button-green"></button>',
          ).on("click", function () {
            confirmButton.attr("disabled", "disabled");
            self.onConfirm();
          }); // Append text to close button

          closeButton.append(vsc_backup_locale.close_import); // Append text to confirm button

          confirmButton.append(vsc_backup_locale.confirm_import + " &gt;"); // Append close button to action
        ...
        this.diskSpaceConfirm = function (params) {
          ...
          confirmButton.append(vsc_backup_locale.confirm_disk_space); // Append close button to action
        ...
        this.blogs = function (params) {
          ...
          var title = $("<span></span>")
            .addClass("ai1wm-title-grey")
            .text(params.title); // Create continue button

          var continueButton = $(
            '<button type="submit" class="ai1wm-button-green"></button>',
          ); // Append text to continue button

          continueButton.append(vsc_backup_locale.continue_import); // Append continue button to action
        ...
        this.info = function (params) {
          ...
          var warning = $("<p></p>").html(
            vsc_backup_locale.please_do_not_close_this_browser,
        ...
        this.done = function (params) {
          ...
          var message = $(
            '<p class="ai1wm-import-modal-content-done"></p>',
          ).html(params.message); // Create action section
          ...
          closeButton.append(vsc_backup_locale.finish_import + " &gt;"); // Append close button to action
        ...
        this.backup_is_encrypted = function (params) {
          ...
          var section = $(
            '<section class="ai1wm-decrypt-backup-section"></section>',
          ); // Create header to hold title

          var header = $("<h1></h1>").html(vsc_backup_locale.backup_encrypted);
          var message = $(
            '<p class="ai1wm-import-decrypt-password-modal-content"></p>',
          ).html(vsc_backup_locale.backup_encrypted_message);
          var confirmButton = $(
            '<button type="button" class="ai1wm-button-green"></button>',
          ).on("click", function () {
            var password = $("#ai1wm-backup-decrypt-password");
            var passwordConfirmation = $(
              "#ai1wm-backup-decrypt-password-confirmation",
            );
          ...
          var passwordContainer = $(
            '<div class="ai1wm-input-password-container"></div>',
          );
          var passwordInput = $(
            '<input type="password" name="password" id="ai1wm-backup-decrypt-password" required />',
          )
            .prop("placeholder", vsc_backup_locale.enter_password)
            .on("keyup", function () {
              var password = $(this);
              var passwordConfirmation = $(
                "#ai1wm-backup-decrypt-password-confirmation",
          ...
          var passwordView = $(
            '<a href="#ai1wm-backup-decrypt-password" class="ai1wm-toggle-password-visibility ai1wm-icon-eye-blocked"></a>',
          ).on("click", function () {
            $(this).toggleClass("ai1wm-icon-eye ai1wm-icon-eye-blocked");
            $(this)
              .prev()
              .prop("type", function (index, oldPropertyValue) {
          ...
          if (params.error) {
            ...
            var passwordError = $(
              '<div class="ai1wm-error-message"></div>',
            ).html(params.error);
          ...
          var passwordConfirmationInput = $(
            '<input type="password" name="password_confirmation" id="ai1wm-backup-decrypt-password-confirmation" required />',
          )
            .prop("placeholder", vsc_backup_locale.repeat_password)
            .on("keyup", function () {
          ...
          var passwordConfirmationView = $(
            '<a href="#ai1wm-backup-decrypt-password-confirmation" class="ai1wm-toggle-password-visibility ai1wm-icon-eye-blocked"></a>',
          ).on("click", function () {
            $(this).toggleClass("ai1wm-icon-eye ai1wm-icon-eye-blocked");
            $(this)
              .prev()
          ...
          var passwordConfirmationError = $(
            '<div class="ai1wm-error-message"></div>',
          ).html(vsc_backup_locale.passwords_do_not_match);
          passwordConfirmationContainer
            .append(passwordConfirmationInput)
            .append(passwordConfirmationView)
            .append(passwordConfirmationError);
          confirmButton.append(vsc_backup_locale.submit);
          closeButton.append(vsc_backup_locale.close_import);
          var buttonContainer = $(
            '<div class="ai1wm-backup-decrypt-button-container"></div>',
          );
          ...
          section
            ...
            .append(message)
            .append(form)
            .append(buttonContainer); // Append section and action to container
    ...
    /***/ 332: /***/ function () {
      ...
      jQuery(document).ready(function ($) {
        ...
        $("#ai1wm-feedback-type-2").on("click", function () {
          ...
          $(".ai1wm-feedback-form")
            .find(".ai1wm-feedback-message")
            .attr("placeholder", vsc_backup_locale.how_may_we_help_you); // Show feedback form
        ...
        $("#ai1wm-feedback-submit").on("click", function (e) {
          ...
          $.ajax({
            url: vsc_backup_feedback.ajax.url,
            type: "POST",
            dataType: "json",
            async: true,
            data: {
              secret_key: vsc_backup_feedback.secret_key,
              vsc_backup_type: type,
              vsc_backup_email: email,
              vsc_backup_message: message,
              vsc_backup_terms: +terms,
            },
            dataFilter: function dataFilter(data) {
              return Ai1wm.Util.json(data);
            },
            ...
            if (data.errors.length > 0) {
              ...
              var successMessage = $("<div />").addClass(
                "ai1wm-message ai1wm-success-message",
              );
              successMessage.append(
                $("<p />").text(
                  vsc_backup_locale.thanks_for_submitting_your_feedback,
                ),
              );
    ...
    /***/ 317: /***/ function (
      ...
      function D(t, e) {
        ...
        try {
          const n = Array.isArray(t),
            o = Array.isArray(e);
          if (n && o)
            return t.length === e.length && t.every((t, n) => D(t, e[n]));
      ...
      const et = () => (
          void 0 === Q &&
            (Q =
              ...
              "server" === __webpack_require__.g.process.env.VUE_ENV),
          Q
        ),
      ...
      const _t = Object.getOwnPropertyNames(yt),
        $t = {};
      let bt = !0;
      function wt(t) {
        bt = t;
      }
      const xt = { notify: j, depend: j, addSub: j, removeSub: j };
      class Ct {
      ...
      function kt(t, n, o) {
        if (!c(t) || Pt(t) || t instanceof at) return;
        let r;
        return (
        ...
        return (
          Object.defineProperty(t, n, {
            ...
            get: function () {
              ...
              return (
                pt.target && (c.depend(), f && (f.dep.depend(), e(n) && At(n))),
                Pt(n) && !s ? n.value : n
              );
            },
            set: function (e) {
              ...
              if (I(n, e)) {
                if (u) u.call(t, e);
                  ...
                  if (l) return;
                  if (Pt(n) && !Pt(e)) return void (n.value = e);
                  o = e;
                }
        ...
        return e(t) && u(n)
          ...
          : n in t && !(n in Object.prototype)
            ...
            : t._isVue || (r && r.vmCount)
              ? o
              : r
                ? (St(r.value, n, o, void 0, r.shallow, r.mock),
                  r.dep.notify(),
                  o)
                : ((t[n] = o), o);
      }
      ...
      function At(t) {
        for (let n, o = 0, r = t.length; o < r; o++)
          ((n = t[o]), n && n.__ob__ && n.__ob__.dep.depend(), e(n) && At(n));
      }
      function jt(t) {
        return (Et(t, !0), U(t, "__v_isShallow", !0), t);
      }
      function Et(t, e) {
        Mt(t) || kt(t, e, et());
      }
      function Nt(t) {
        return Mt(t) ? Nt(t.__v_raw) : !(!t || !t.__ob__);
      }
      function Dt(t) {
      ...
      function It(t, e) {
        ...
        return (
          U(n, "__v_isRef", !0),
          U(n, "__v_isShallow", e),
          U(n, "dep", St(n, "value", t, null, e, et())),
          n
        );
      }
      function Rt(t, e, n) {
        ...
        function o() {
          ...
          if (!e(t)) return en(t, null, arguments, n, "v-on handler");
          {
            ...
            for (let t = 0; t < e.length; t++)
              en(e[t], null, arguments, n, "v-on handler");
          }
        }
        return ((o.fns = t), o);
      }
      function Vt(t, e, o, s, i, c) {
        let a, l, u, f;
        for (a in t)
          ((l = t[a]),
            (u = e[a]),
      ...
      function qt(t) {
        return s(t) ? [ut(t)] : e(t) ? Zt(t) : void 0;
      }
      function Wt(t) {
            ...
            n(l) ||
              ...
              e(l)
                ? l.length > 0 &&
                  ...
                  Wt(l[0]) &&
                    Wt(f) &&
                    ((c[u] = ut(f.text + l[0].text)), l.shift()),
                  c.push.apply(c, l))
                : s(l)
                  ? Wt(f)
                    ? (c[u] = ut(f.text + l))
            ...
            if ("string" == typeof n) {
              ...
              ((u = (t.$vnode && t.$vnode.ns) || F.getTagNamespace(n)),
                (l = F.isReservedTag(n)
                  ...
                  : (r && r.pre) || !o((e = oo(t.$options, "components", n)))
            ...
            return e(l)
              ...
              : o(l)
                ? (o(u) && Xt(l, u),
                  o(r) &&
                    (function (t) {
                      c(t.style) && Sn(t.style);
                      c(t.class) && Sn(t.class);
                    })(r),
                  l)
                : lt();
          })(t, n, a, l, u)
      ...
      function Xt(t, e, s) {
        if (
          ...
          for (let i = 0, c = t.children.length; i < c; i++) {
            ...
            o(c.tag) && (n(c.ns) || (r(s) && "svg" !== c.tag)) && Xt(c, e, s);
          }
      }
      function Yt(t, n) {
        let r,
      ...
      function te(t) {
        return oo(this.$options, "filters", t) || N;
      }
      function ee(t, n) {
      ...
      function ie(t, n, o) {
        if (e(t))
          for (let e = 0; e < t.length; e++)
            t[e] && "string" != typeof t[e] && ce(t[e], `${n}_${e}`, o);
        else ce(t, n, o);
      }
      function ce(t, e, n) {
      ...
      function pe(t, e) {
        ...
        for (const t in n) n[t].every(he) && delete n[t];
        return n;
      }
      function he(t) {
      ...
      function ge(e, n, o, r) {
        ...
        if (n) {
          ...
          if (c && r && r !== t && a === r.$key && !i && !r.$hasNormal)
            return r;
          s = {};
          for (const t in n) n[t] && "$" !== t[0] && (s[t] = ve(e, o, t, n[t]));
        } else s = {};
        for (const t in o) t in s || (s[t] = ye(o, t));
        return (
      ...
      function ve(t, n, o, r) {
        const s = function () {
          ...
          return (
            ct(n),
            o && (!s || (1 === o.length && s.isComment && !me(s))) ? void 0 : o
          );
        };
        return (
          r.proxy &&
          ...
          get attrs() {
            return (function (e) {
              if (!e._attrsProxy) {
                ...
                (U(n, "_v_attr_proxy", !0), $e(n, e.$attrs, t, e));
              }
      ...
      function $e(t, e, n, o) {
        let r = !1;
        for (const s in e)
          s in t ? e[s] !== n[s] && (r = !0) : ((r = !0), be(t, s, o));
        for (const n in t) n in e || ((r = !0), delete t[n]);
        return r;
      }
      function be(t, e, n) {
        Object.defineProperty(t, e, {
      ...
      function xe() {
        const t = it;
        return t._setupContext || (t._setupContext = _e(t));
      }
      let Ce,
        ke = null;
      function Se(t, e) {
      ...
      function Ee(t, e, n) {
        ((Ce = t), Vt(e, n || {}, Te, Ae, je, t), (Ce = void 0));
      }
      let Ne = null;
      function De(t) {
        const e = Ne;
      ...
      function Pe(t, e) {
        ...
        if (t._inactive || null === t._inactive) {
          t._inactive = !1;
          for (let e = 0; e < t.$children.length; e++) Pe(t.$children[e]);
          Re(t, "activated");
        }
      }
      function Ie(t, e) {
      ...
      function Re(t, e, n, o = !0) {
        ...
        if (s)
          for (let e = 0, o = s.length; e < o; e++)
            en(s[e], t, n || null, t, i);
        (t._hasHookEvent && t.$emit("hook:" + e), o && ct(r), gt());
      }
      const Le = [],
        Fe = [];
      let He = {},
      ...
      function Je() {
        let t, e;
        for (
          Ve = Ke(), Ue = !0, Le.sort((t, e) => t.id - e.id), ze = 0;
          ze < Le.length;
          ze++
        )
          ((t = Le[ze]),
        ...
        const n = Fe.slice(),
          o = Le.slice();
        ((ze = Le.length = Fe.length = 0),
          (He = {}),
          (Be = Ue = !1),
          (function (t) {
            for (let e = 0; e < t.length; e++)
              ((t[e]._inactive = !0), Pe(t[e], !0));
          })(n),
          (function (t) {
            let e = t.length;
            for (; e--; ) {
      ...
      function qe(t) {
        const e = t.id;
        if (null == He[e] && (t !== pt.target || !t.noRecurse)) {
          if (((He[e] = !0), Ue)) {
            let e = Le.length - 1;
            for (; e > ze && Le[e].id > t.id; ) e--;
            Le.splice(e + 1, 0, t);
          } else Le.push(t);
          Be || ((Be = !0), un(Je));
        }
      ...
      function Ge(
        ...
        const v = new An(it, d, j, { lazy: !0 });
        v.noRecurse = !o;
        let y = m ? [] : Ze;
        return (
          (v.run = () => {
            if (v.active || ("pre" === c && u && u._isBeingDestroyed))
              if (o) {
                const t = v.get();
                (s || h || (m ? t.some((t, e) => I(t, y[e])) : I(t, y))) &&
                  (p && p(),
                  f(o, "watcher callback", [t, y === Ze ? void 0 : y, g]),
                  (y = t));
              } else v.get();
          }),
          "sync" === c
      ...
      function Qe(t, e) {
        if (it) {
          let n = it._provided;
          const o = it.$parent && it.$parent._provided;
          (o === n && (n = it._provided = Object.create(o)), (n[t] = e));
        } else;
      }
      function tn(t, e, n) {
        mt();
        ...
        try {
          ((s = n ? t.apply(e, n) : t.call(e)),
            s &&
              ...
              f(s) &&
              !s._handled &&
              (s.catch((t) => tn(t, o, r + " (Promise/async)")),
              (s._handled = !0)));
        } catch (t) {
          tn(t, o, r);
        }
      ...
      const dn = fn("beforeMount"),
        ...
        _n = fn("activated"),
        $n = fn("deactivated"),
        bn = fn("serverPrefetch"),
        wn = fn("renderTracked"),
        xn = fn("renderTriggered");
      var Cn = Object.freeze({
        ...
        computed: function (t, e) {
          ...
          const s = et() ? null : new An(it, n, j, { lazy: !0 }),
            c = {
              effect: s,
              get value() {
                return s
                  ? (s.dirty && s.evaluate(), pt.target && s.depend(), s.value)
                  : n();
              },
              set value(t) {
                o(t);
        ...
        onServerPrefetch: bn,
        onRenderTracked: wn,
        onRenderTriggered: xn,
      });
      const kn = new st();
      function Sn(t) {
        return (On(t, kn), kn.clear(), t);
      }
      function On(t, n) {
        let o, r;
        const s = e(t);
        if (!((!s && !c(t)) || Object.isFrozen(t) || t instanceof at)) {
          if (t.__ob__) {
            const e = t.__ob__.dep.id;
            if (n.has(e)) return;
            n.add(e);
          }
          if (s) for (o = t.length; o--; ) On(t[o], n);
          else if (Pt(t)) On(t.value, n);
          else for (r = Object.keys(t), o = r.length; o--; ) On(t[r[o]], n);
        }
      }
      let Tn = 0;
      class An {
        ...
        get() {
          ...
          try {
            ...
            tn(t, e, `getter for watcher "${this.expression}"`);
          } finally {
      ...
      const jn = { enumerable: !0, configurable: !0, get: j, set: j };
      function En(t, e, n) {
        ((jn.get = function () {
          return this[e][n];
        }),
        ...
        if (
          (n.props &&
            (function (t, e) {
              ...
              for (const s in e) {
                r.push(s);
                (St(o, s, ro(s, e, n, t)), s in t || En(t, "_props", s));
              }
              wt(!0);
            })(t, n.props),
          (function (t) {
            const e = t.$options,
              n = e.setup;
            if (n) {
              const o = (t._setupContext = _e(t));
              (ct(t), mt());
              const r = en(n, null, [t._props || jt({}), o], t, "setup");
              if ((gt(), ct(), i(r))) e.render = r;
              else if (c(r))
        ...
        (n.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const s = e[r],
                c = i(s) ? s : s.get;
              (o || (n[r] = new An(t, c || j, j, Dn)), r in t || Mn(t, r, s));
            }
          })(t, n.computed),
          n.watch &&
            n.watch !== Y &&
            (function (t, n) {
              for (const o in n) {
                const r = n[o];
                if (e(r)) for (let e = 0; e < r.length; e++) Rn(t, o, r[e]);
                else Rn(t, o, r);
              }
            })(t, n.watch));
      }
      ...
      function Mn(t, e, n) {
        const o = !et();
        (i(n)
          ? ((jn.get = o ? Pn(e) : In(n)), (jn.set = j))
          : ((jn.get = n.get ? (o && !1 !== n.cache ? Pn(e) : In(n.get)) : j),
            (jn.set = n.set || j)),
        ...
        if (t.super) {
          ...
          if (n !== t.superOptions) {
            ...
            (o && T(t.extendOptions, o),
              (e = t.options = no(n, t.extendOptions)),
              e.name && (e.components[e.name] = t));
          }
        }
        return e;
      }
      function Bn(n, o, s, i, c) {
        const a = c.options;
        let l;
        _(i, "_uid")
        ...
        ((this.data = n),
          ...
          (this.injections = Ln(a.inject, i)),
          (this.slots = () => (
            this.$slots || ge(i, n.scopedSlots, (this.$slots = pe(s, i))),
            this.$slots
          )),
          ...
          a._scopeId
            ? (this._c = (t, n, o, r) => {
                const s = Gt(l, t, n, o, r, f);
                return (
                  s && !e(s) && ((s.fnScopeId = a._scopeId), (s.fnContext = i)),
                  s
                );
              })
            : (this._c = (t, e, n, o) => Gt(l, t, e, n, o, f)));
      }
      ...
      const Kn = {
          ...
          prepatch(e, n) {
            ...
            !(function (e, n, o, r, s) {
              ...
              if (
                (e._attrsProxy &&
                  $e(e._attrsProxy, f, (u.data && u.data.attrs) || t, e) &&
                  (l = !0),
                (e.$attrs = f),
                (e.$listeners = o || t),
                n && e.$options.props)
              ...
              ((e.$options._parentListeners = o),
                Ee(e, o, d),
                l && ((e.$slots = pe(s, r.context)), e.$forceUpdate()));
            })(
          ...
          (s = (function (t, e) {
            ...
            if (s && !o(t.owners)) {
              ...
              const u = (t) => {
                ...
                d = P((n) => {
                  ((t.resolved = Se(n, e)), i ? (r.length = 0) : u(!0));
                }),
                p = P((e) => {
                ...
                c(h) &&
                  (f(h)
                    ...
                    : f(h.component) &&
                      ...
                      o(h.error) && (t.errorComp = Se(h.error, e)),
                      o(h.loading) &&
        ...
        if (r(s.options.functional))
          return (function (n, r, s, i, c) {
            const a = n.options,
              l = {},
              u = a.props;
            if (o(u)) for (const e in u) l[e] = ro(e, u, r || t);
            else (o(s.attrs) && zn(l, s.attrs), o(s.props) && zn(l, s.props));
            const f = new Bn(s, l, c, i, n),
              d = a.render.call(null, f._c, f);
            if (d instanceof at) return Un(d, s, f.parent, a);
            if (e(d)) {
              const t = qt(d) || [],
                e = new Array(t.length);
              for (let n = 0; n < t.length; n++)
                e[n] = Un(t[n], s, f.parent, a);
              return e;
            }
          })(s, h, i, a, l);
        const m = i.on;
        ...
        !(function (t) {
          ...
          for (let t = 0; t < Jn.length; t++) {
            const n = Jn[t],
              o = e[n],
              r = Kn[n];
            o === r || (o && o._merged) || (e[n] = o ? Wn(r, o) : r);
          }
        })(i);
        const g = Vn(s.options) || u;
        return new at(
      ...
      let Zn = j;
      const Gn = F.optionMergeStrategies;
      function Xn(t, e) {
        if (!e) return t;
        let n, o, r;
        ...
        for (let i = 0; i < s.length; i++)
          ((n = s[i]),
            "__ob__" !== n &&
              ((o = t[n]),
              (r = e[n]),
              _(t, n) ? o !== r && l(o) && l(r) && Xn(o, r) : Ot(t, n, r)));
        return t;
      }
      function Yn(t, e, n) {
        return n
      ...
      function no(t, n, o) {
        if (
          ...
          (function (t, n) {
            ...
            const r = (t.inject = {});
            if (e(o))
              for (let t = 0; t < o.length; t++) r[o[t]] = { from: o[t] };
            else if (l(o))
              for (const t in o) {
                const e = o[t];
          ...
          !n._base && (n.extends && (t = no(t, n.extends, o)), n.mixins))
        )
          for (let e = 0, r = n.mixins.length; e < r; e++)
            t = no(t, n.mixins[e], o);
        const r = {};
        let s;
        for (s in t) c(s);
        ...
        if (void 0 === c) {
          c = (function (t, e, n) {
            ...
            if (
              ...
              return t._props[n];
            return i(o) && "Function" !== io(e.type) ? o.call(t) : o;
          })(o, r, t);
          const e = bt;
          (wt(!0), kt(c), wt(e));
        }
      ...
      const so = /^\s*function (\w+)/;
      function io(t) {
        const e = t && t.toString().match(so);
        return e ? e[1] : "";
      }
      function co(t, e) {
        return io(t) === io(e);
      ...
      function uo(t) {
        ...
        t.extend = function (t) {
          ...
          return (
            ...
            (i.cid = e++),
            (i.options = no(n.options, t)),
            (i.super = n),
            i.options.props &&
              (function (t) {
                const e = t.options.props;
                for (const n in e) En(t.prototype, "_props", n);
              })(i),
            i.options.computed &&
              (function (t) {
                const e = t.options.computed;
                for (const n in e) Mn(t.prototype, n, e[n]);
              })(i),
            (i.extend = n.extend),
            (i.mixin = n.mixin),
            (i.use = n.use),
      ...
      function fo(t) {
        return t && (Vn(t.Ctor.options) || t.tag);
      }
      function po(t, n) {
        return e(t)
          ? t.indexOf(n) > -1
        ...
        e.prototype._init = function (e) {
          ...
          ((n._uid = Fn++),
            ...
            e && e._isComponent
              ...
              : (n.$options = no(Hn(n.constructor), e || {}, n)),
            (n._renderProxy = n),
            (n._self = n),
            (function (t) {
              const e = t.$options;
            ...
            (function (e) {
              ...
              const n = e.$options,
                ...
                r = o && o.context;
              ((e.$slots = pe(n._renderChildren, r)),
                (e.$scopedSlots = t),
                (e._c = (t, n, o, r) => Gt(e, t, n, o, r, !1)),
                (e.$createElement = (t, n, o, r) => Gt(e, t, n, o, r, !0)));
              const s = o && o.data;
            ...
            (function (t) {
              ...
              if (e) {
                ...
                if (!c(n)) return;
                const o = rt ? Reflect.ownKeys(n) : Object.keys(n);
                ct(t);
                for (let t = 0; t < o.length; t++) Qe(o[t], n[o[t]]);
                ct();
              }
            })(n),
            Re(n, "created"),
        ...
        (function (t) {
          ...
          ((t.prototype.$on = function (t, o) {
            ...
            (t.prototype.$off = function (t, n) {
              const o = this;
              if (!arguments.length)
                return ((o._events = Object.create(null)), o);
              if (e(t)) {
            ...
            (t.prototype.$emit = function (t) {
              ...
              if (n) {
                ...
                for (let t = 0, s = n.length; t < s; t++) en(n[t], e, o, e, r);
              }
              return e;
            }));
        })(lo),
      ...
      (!(function (t) {
        ...
        (Object.defineProperty(t, "config", e),
          ...
          (function (t) {
            t.mixin = function (t) {
              return ((this.options = no(this.options, t)), this);
            };
          })(t),
          uo(t),
          (function (t) {
        ...
        Object.defineProperty(lo.prototype, "$isServer", { get: et }),
        Object.defineProperty(lo.prototype, "$ssrContext", {
          get() {
            return this.$vnode && this.$vnode.ssrContext;
          },
        }),
        Object.defineProperty(lo, "FunctionalRenderContext", { value: Bn }),
        (lo.version = "2.7.5"));
      const yo = h("style,class"),
        _o = h("input,textarea,option,select,progress"),
        $o = (t, e, n) =>
          ("value" === n && _o(t) && "button" !== e) ||
          ("selected" === n && "option" === t) ||
          ("checked" === n && "input" === t) ||
          ("muted" === n && "video" === t),
        bo = h("contenteditable,draggable,spellcheck"),
        wo = h("events,caret,typing,plaintext-only"),
        xo = h(
          "allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,default,defaultchecked,defaultmuted,defaultselected,defer,disabled,enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,required,reversed,scoped,seamless,selected,sortable,truespeed,typemustmatch,visible",
        ),
        Co = "http://www.w3.org/1999/xlink",
        ko = (t) => ":" === t.charAt(5) && "xlink" === t.slice(0, 5),
        So = (t) => (ko(t) ? t.slice(6, t.length) : ""),
        Oo = (t) => null == t || !1 === t;
      function To(t) {
        let e = t.data,
          n = t,
        ...
        for (; o((n = n.parent)); ) n && n.data && (e = Ao(e, n.data));
        return (function (t, e) {
          if (o(t) || o(e)) return jo(t, Eo(e));
          return "";
      ...
      const Lo = h("text,number,password,search,email,tel,url");
      function Fo(t) {
        if ("string" == typeof t) {
      ...
      function Uo(t, n) {
        ...
        const s = t.context,
          ...
          a = n ? null : c,
          l = n ? void 0 : c;
        if (i(r)) return void en(r, s, [a], s, "template ref function");
      ...
      function zo({ _setupState: t }, e, n) {
        t && _(t, e) && (Pt(t[e]) ? (t[e].value = n) : (t[e] = n));
      }
      const Vo = new at("", {}, []),
      ...
      function Zo(t, e) {
        (t.data.directives || e.data.directives) &&
          (function (t, e) {
            const n = t === Vo,
              o = e === Vo,
              r = Xo(t.data.directives, t.context),
              s = Xo(e.data.directives, e.context),
              i = [],
              c = [];
            let a, l, u;
            for (a in s)
            ...
            c.length &&
              Kt(e, "postpatch", () => {
                for (let n = 0; n < c.length; n++)
                  Qo(c[n], "componentUpdated", e, t);
              });
            if (!n) for (a in r) s[a] || Qo(r[a], "unbind", t, t, o);
          })(t, e);
      }
      ...
      function Xo(t, e) {
        ...
        for (o = 0; o < t.length; o++)
          ((r = t[o]),
            ...
            e._setupState &&
              e._setupState.__sfc &&
              (r.def = r.def || oo(e, "_setupState", "v-" + r.name)),
            (r.def = r.def || oo(e.$options, "directives", r.name)));
        return n;
      }
      function Yo(t) {
        return (
      ...
      function Qo(t, e, n, o, r) {
        ...
        if (s)
          try {
            ...
            tn(o, n.context, `directive ${t.name} ${e} hook`);
          }
      }
      var tr = [Bo, Wo];
      function er(t, e) {
        ...
        for (i in ((o(f.__ob__) || r(f._v_attr_proxy)) &&
          (f = e.data.attrs = T({}, f)),
        f))
          ((c = f[i]), (a = u[i]), a !== c && nr(l, i, c, e.data.pre));
        for (i in ((q || Z) && f.value !== u.value && nr(l, "value", f.value),
        u))
          n(f[i]) &&
            (ko(i)
              ? l.removeAttributeNS(Co, So(i))
              : bo(i) || l.removeAttribute(i));
      }
      function nr(t, e, n, o) {
            ...
            : bo(e)
              ? t.setAttribute(
                  ...
                  ((t, e) =>
                    Oo(e) || "false" === e
                      ? "false"
                      : "contenteditable" === t && wo(e)
                        ? e
                        : "true")(e, n),
                )
              : ko(e)
                ? Oo(n)
                  ? t.removeAttributeNS(Co, So(e))
      ...
      function sr(t, e) {
        ...
        (o(a) && (c = jo(c, Eo(a))),
          c !== r._prevClass &&
            (r.setAttribute("class", c), (r._prevClass = c)));
      }
      ...
      function ar(t) {
        ...
        if ((void 0 === r ? (r = t.slice(0, o).trim()) : 0 !== p && h(), s))
          for (o = 0; o < s.length; o++) r = lr(r, s[o]);
        return r;
      }
      function lr(t, e) {
        const n = e.indexOf("(");
      ...
      function pr(t, e, n, o, r) {
        ((r
          ...
          : t.attrs || (t.attrs = [])
        ).push(br({ name: e, value: n, dynamic: r }, o)),
          (t.plain = !1));
      }
      function hr(t, e, n, o) {
        ((t.attrsMap[e] = n), t.attrsList.push(br({ name: e, value: n }, o)));
      }
      function mr(t, e, n, o, r, s, i, c) {
        ...
        ((r = r || t).right
          ...
          : r.middle &&
            (a
              ? (n = `(${n})==='click'?'mouseup':(${n})`)
              : "click" === n && (n = "mouseup")),
          r.capture && (delete r.capture, (n = gr("!", n, a))),
          r.once && (delete r.once, (n = gr("~", n, a))),
          r.passive && (delete r.passive, (n = gr("&", n, a))),
          r.native
            ? (delete r.native, (l = e.nativeEvents || (e.nativeEvents = {})))
            : (l = e.events || (e.events = {})));
        const u = br({ value: o.trim(), dynamic: a }, c);
        r !== t && (u.modifiers = r);
        const f = l[n];
        (Array.isArray(f)
          ? s
      ...
      function yr(t, e, n) {
        const o = _r(t, ":" + e) || _r(t, "v-bind:" + e);
        if (null != o) return ar(o);
        if (!1 !== n) {
          const n = _r(t, e);
        ...
        const n = (function (t) {
          if (
            ...
            return (
              (Or = t.lastIndexOf(".")),
              Or > -1
                ? { exp: t.slice(0, Or), key: '"' + t.slice(Or + 1) + '"' }
                : { exp: t, key: null }
            );
          ((kr = t), (Or = Tr = Ar = 0));
          for (; !Er(); ) ((Sr = jr()), Nr(Sr) ? Mr(Sr) : 91 === Sr && Dr(Sr));
          return { exp: t.slice(0, Tr), key: t.slice(Tr + 1, Ar) };
        })(t);
        return null === n.key ? `${t}=${e}` : `$set(${n.exp}, ${n.key}, ${e})`;
      }
      let Cr, kr, Sr, Or, Tr, Ar;
      function jr() {
      ...
      function Lr(t, e, n, o) {
        ...
        Pr.addEventListener(t, e, tt ? { capture: n, passive: o } : n);
      }
      function Fr(t, e, n, o) {
        (o || Pr).removeEventListener(t, e._wrapper || e, n);
      }
      function Hr(t, e) {
        ...
        ((Pr = e.elm || t.elm),
          ...
          Vt(r, s, Lr, Fr, Ir, e.context),
          (Pr = void 0));
      }
      var Br = { create: Hr, update: Hr, destroy: (t) => Hr(t, Vo) };
      let Ur;
      function zr(t, e) {
        ...
        for (s in l) {
          ...
          if ("value" === s && "PROGRESS" !== c.tagName) {
            ...
            Vr(c, t) && (c.value = t);
          } else if ("innerHTML" === s && Mo(c.tagName) && n(c.innerHTML)) {
            ((Ur = Ur || document.createElement("div")),
              (Ur.innerHTML = `<svg>${i}</svg>`));
      ...
      const Zr = /^--/,
        ...
        Xr = (t, e, n) => {
          if (Zr.test(e)) t.style.setProperty(e, n);
            ...
            t.style.setProperty(k(e), n.replace(Gr, ""), "important");
          else {
            const o = ts(e);
            if (Array.isArray(n))
      ...
      function es(t, e) {
        const r = e.data,
          s = t.data;
        if (n(r.staticStyle) && n(r.style) && n(s.staticStyle) && n(s.style))
          return;
        let i, c;
        const a = e.elm,
          l = s.staticStyle,
          ...
          if (e) {
            ...
            for (; e.componentInstance; )
              ((e = e.componentInstance._vnode),
                e && e.data && (o = qr(e.data)) && T(n, o));
          }
          (o = qr(t.data)) && T(n, o);
          let r = t;
          for (; (r = r.parent); ) r.data && (o = qr(r.data)) && T(n, o);
          return n;
        })(e, !0);
        for (c in f) n(p[c]) && Xr(a, c, "");
        for (c in p) ((i = p[c]), i !== f[c] && Xr(a, c, null == i ? "" : i));
      }
      ...
      function rs(t, e) {
        if (e && (e = e.trim()))
          if (t.classList)
            e.indexOf(" ") > -1
              ? e.split(os).forEach((e) => t.classList.add(e))
              : t.classList.add(e);
          else {
      ...
      function ss(t, e) {
        if (e && (e = e.trim()))
          if (t.classList)
            (e.indexOf(" ") > -1
              ? e.split(os).forEach((e) => t.classList.remove(e))
      ...
      function is(t) {
        if (t) {
          if ("object" == typeof t) {
            const e = {};
            return (!1 !== t.css && T(e, cs(t.name || "v")), T(e, t), e);
          }
      ...
      as &&
        (void 0 === window.ontransitionend &&
          ...
          ((ls = "WebkitTransition"), (us = "webkitTransitionEnd")),
        void 0 === window.onanimationend &&
          void 0 !== window.onwebkitanimationend &&
          ((fs = "WebkitAnimation"), (ds = "webkitAnimationEnd")));
      const ps = K
      ...
      function gs(t, e) {
        (t._transitionClasses && v(t._transitionClasses, e), ss(t, e));
      }
      function vs(t, e, n) {
        const { type: o, timeout: r, propCount: s } = _s(t, e);
        if (!o) return n();
        const i = "transition" === o ? us : ds;
        let c = 0;
        const a = () => {
      ...
      function _s(t, e) {
        const n = window.getComputedStyle(t),
          o = (n[ls + "Delay"] || "").split(", "),
          r = (n[ls + "Duration"] || "").split(", "),
          s = $s(o, r),
          i = (n[fs + "Delay"] || "").split(", "),
          c = (n[fs + "Duration"] || "").split(", "),
          a = $s(i, c);
        let l,
          u = 0,
          f = 0;
      ...
      function ws(t, e) {
        ...
        const A = T && h ? h : u,
          ...
          H = (r._enterCb = P(() => {
            (L && (gs(r, E), gs(r, j)),
              H.cancelled ? (L && gs(r, A), I && I(r)) : M && M(r),
              (r._enterCb = null));
          }));
        (t.data.show ||
          Kt(t, "insert", () => {
          ...
          L &&
            ...
            hs(() => {
              (gs(r, A),
                H.cancelled ||
                  (ms(r, E), F || (Cs(R) ? setTimeout(H, R) : vs(r, l, H))));
            })),
          t.data.show && (e && e(), D && D(r, H)),
          L || F || H());
      }
      function xs(t, e) {
        const r = t.elm;
        ...
        const {
          ...
          w = (r._leaveCb = P(() => {
            (r.parentNode &&
              ...
              _ && (gs(r, u), gs(r, f)),
              w.cancelled ? (_ && gs(r, l), g && g(r)) : (e(), m && m(r)),
              (r._leaveCb = null));
          }));
        function x() {
          w.cancelled ||
            ...
            _ &&
              ...
              hs(() => {
                (gs(r, l),
                  w.cancelled ||
                    (ms(r, u), $ || (Cs(b) ? setTimeout(w, b) : vs(r, a, w))));
              })),
            h && h(r, w),
            _ || $ || w());
        }
      ...
      const Os = (function (t) {
        ...
        for (i = 0; i < Ko.length; ++i)
          for (a[Ko[i]] = [], c = 0; c < l.length; ++c)
            o(l[c][Ko[i]]) && a[Ko[i]].push(l[c][Ko[i]]);
        function f(t) {
        ...
        function y(t, e) {
          for (let e = 0; e < a.create.length; ++e) a.create[e](Vo, t);
          ((i = t.data.hook),
            o(i) && (o(i.create) && i.create(Vo, t), o(i.insert) && e.push(t)));
        }
        function _(t) {
          let e;
        ...
        return function (t, e, s, i) {
          ...
          if (n(t)) ((c = !0), d(e, l));
            ...
            if (!n && Jo(t, e)) k(t, e, l, null, null, i);
            else {
              if (n) {
                if (
                  (1 === t.nodeType &&
                  ...
                  return (S(e, l, !0), t);
                ((f = t),
                  (t = new at(u.tagName(f).toLowerCase(), {}, [], void 0, f)));
              }
              const i = t.elm,
                c = u.parentNode(i);
              if (
                (d(e, l, i._leaveCb ? null : c, u.nextSibling(i)), o(e.parent))
              ) {
                let t = e.parent;
                const n = v(e);
                for (; t; ) {
        ...
        inserted(t, e, n, o) {
          "select" === n.tag
            ...
            : ("textarea" === n.tag || Lo(t.type)) &&
              ...
              e.modifiers.lazy ||
                (t.addEventListener("compositionstart", Ds),
        ...
        componentUpdated(t, e, n) {
          if ("select" === n.tag) {
            ...
            if (r.some((t, e) => !D(t, o[e]))) {
              (t.multiple
                ? e.value.some((t) => Es(t, r))
                : e.value !== e.oldValue && Es(e.value, r)) && Ps(t, "change");
            }
          }
        },
      };
      ...
      function js(t, e, n) {
        ...
        for (let e = 0, n = t.options.length; e < n; e++)
          if (((i = t.options[e]), r))
            ((s = M(o, Ns(i)) > -1), i.selected !== s && (i.selected = s));
          else if (D(Ns(i), o))
      ...
      function Ms(t) {
        t.target.composing &&
          ((t.target.composing = !1), Ps(t.target, "input"));
      }
      function Ps(t, e) {
      ...
      var Rs = {
          bind(t, { value: e }, n) {
            const o = (n = Is(n)).data && n.data.transition,
      ...
      function Hs(t) {
        ...
        return e && e.Ctor.options.abstract ? Hs(Oe(e.children)) : t;
      }
      function Bs(t) {
        const e = {},
          n = t.$options;
      ...
      var Ks = {
        ...
        render(t) {
          ...
          if (!e) return;
          if (((e = e.filter(zs)), !e.length)) return;
          const n = this.mode,
            o = e[0];
          if (
            (function (t) {
            ...
            null == r.key
              ...
              : s(r.key)
                ? 0 === String(r.key).indexOf(i)
                  ...
                  : i + r.key
                : r.key;
          const c = ((r.data || (r.data = {})).transition = Bs(this)),
            a = this._vnode,
            l = Hs(a);
          if (
            (r.data.directives &&
              r.data.directives.some(Vs) &&
              (r.data.show = !0),
            l &&
              l.data &&
              !(function (t, e) {
      ...
      const Js = T({ tag: String, moveClass: String }, Fs);
      delete Js.mode;
      var qs = {
        props: Js,
        beforeMount() {
      ...
      var Xs = { Transition: Ks, TransitionGroup: qs };
      ((lo.config.mustUseProp = $o),
        (lo.config.isReservedTag = Po),
        (lo.config.isReservedAttr = yo),
        (lo.config.getTagNamespace = Io),
        ...
        T(lo.options.directives, Ls),
        T(lo.options.components, Xs),
        (lo.prototype.__patch__ = K ? Os : j),
        (lo.prototype.$mount = function (t, e) {
          return (function (t, e, n) {
            ...
            return (
              null == t.$vnode && ((t._isMounted = !0), Re(t, "mounted")),
              t
            );
          })(this, (t = t && K ? Fo(t) : void 0), e);
        }),
        K &&
          setTimeout(() => {
            F.devtools && nt && nt.emit("init", lo);
          }, 0));
      const Ys = /\{\{((?:.|\r?\n)+?)\}\}/g,
        Qs = /[-.*+?^${}()|[\]\/\\]/g,
        ti = $((t) => {
          const e = t[0].replace(Qs, "\\$&"),
            n = t[1].replace(Qs, "\\$&");
          return new RegExp(e + "((?:.|\\n)+?)" + n, "g");
        });
      var ei = {
      ...
      const si = h(
        ...
        ii = h("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source"),
        ci = h(
        ...
        li =
          /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+?\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
        ui = `[a-zA-Z_][\\-\\.0-9_a-zA-Z${H.source}]*`,
        fi = `((?:${ui}\\:)?${ui})`,
        di = new RegExp(`^<${fi}`),
        pi = /^\s*(\/?)>/,
        hi = new RegExp(`^<\\/${fi}[^>]*>`),
      ...
      function Wi(t, e) {
        ((Fi = e.warn || ur),
          (Vi = e.isPreTag || E),
          (Ki = e.mustUseProp || E),
          (Ji = e.getTagNamespace || E),
          e.isReservedTag,
          (Bi = fr(e.modules, "transformNode")),
          (Ui = fr(e.modules, "preTransformNode")),
          (zi = fr(e.modules, "postTransformNode")),
          (Hi = e.delimiters));
        const n = [],
        ...
        function l(t) {
          if (
            (u(t),
            c || t.processed || (t = Zi(t, e)),
            n.length ||
              t === s ||
              (s.if &&
                (t.elseif || t.else) &&
                Xi(s, { exp: t.elseif, block: t })),
            i && !t.forbidden)
          )
            if (t.elseif || t.else)
              !(function (t, e) {
                ...
                n && n.if && Xi(n, { exp: t.elseif, block: t });
              })(t, i);
            else {
              if (t.slotScope) {
          ...
          ((t.children = t.children.filter((t) => !t.slotScope)),
            ...
            t.pre && (c = !1),
            Vi(t.tag) && (a = !1));
          for (let n = 0; n < zi.length; n++) zi[n](t, e);
        }
        function u(t) {
          if (!a) {
            let e;
          ...
          (function (t, e) {
            ...
            function u() {
              ...
              if (e) {
                ...
                for (
                  l(e[0].length);
                  !(o = t.match(pi)) && (r = t.match(li) || t.match(ai));
            ...
            start(t, o, r, u, f) {
              ...
              q &&
                ...
                (o = (function (t) {
                  ...
                  for (let n = 0; n < t.length; n++) {
                    const o = t[n];
                    ec.test(o.name) ||
                      ((o.name = o.name.replace(nc, "")), e.push(o));
                  }
                  return e;
                })(o));
              let p = qi(t, o, i);
              ...
              (d && (p.ns = d),
                ("style" !== (h = p).tag &&
                  ...
                  et() ||
                  (p.forbidden = !0));
              for (let t = 0; t < Ui.length; t++) p = Ui[t](p, e) || p;
              (c ||
                (!(function (t) {
                  null != _r(t, "v-pre") && (t.pre = !0);
                })(p),
                p.pre && (c = !0)),
                Vi(p.tag) && (a = !0),
                c
                  ...
                  : p.processed ||
                    ...
                    (function (t) {
                      const e = _r(t, "v-if");
                      if (e) ((t.if = e), Xi(t, { exp: e, block: t }));
                      else {
                        null != _r(t, "v-else") && (t.else = !0);
                        const e = _r(t, "v-else-if");
                        e && (t.elseif = e);
                      }
                    })(p),
                    (function (t) {
                      null != _r(t, "v-once") && (t.once = !0);
                    })(p)),
                s || (s = p),
                r ? l(p) : ((i = p), n.push(p)));
            },
      ...
      function Zi(t, e) {
        ...
        (!(function (t) {
          ...
          (function (t) {
            let e;
            "template" === t.tag
              ? ((e = _r(t, "scope")), (t.slotScope = e || _r(t, "slot-scope")))
              : (e = _r(t, "slot-scope")) && (t.slotScope = e);
            const n = yr(t, "slot");
            n &&
          ...
          (function (t) {
            ...
            null != _r(t, "inline-template") && (t.inlineTemplate = !0);
          })(t));
        for (let n = 0; n < Bi.length; n++) t = Bi[n](t, e) || t;
        return (
          (function (t) {
            const e = t.attrsList;
            let n, o, r, s, i, c, a, l;
            for (n = 0, o = e.length; n < o; n++)
              if (((r = s = e[n].name), (i = e[n].value), Oi.test(r)))
                if (
                  ((t.hasBindings = !0),
                  (c = Qi(r.replace(Oi, ""))),
                  c && (r = r.replace(Mi, "")),
                  ...
                  ((r = r.replace(Di, "")),
                    ...
                    c &&
                      ...
                      c.sync &&
                        ((a = xr(i, "$event")),
                        l
                          ? vr(t, `"update:"+(${r})`, a, null, !1, 0, e[n], !0)
                          : (vr(t, `update:${w(r)}`, a, null, !1, 0, e[n]),
                            k(r) !== w(r) &&
                              vr(t, `update:${k(r)}`, a, null, !1, 0, e[n])))),
                    (c && c.prop) ||
                    (!t.component && Ki(t.tag, t.attrsMap.type, r))
                      ? dr(t, r, i, e[n], l)
                      : pr(t, r, i, e[n], l));
                else if (Si.test(r))
                  ((r = r.replace(Si, "")),
                  ...
                  ((l = !1),
                    a &&
                      ...
                      Ei.test(a) && ((a = a.slice(1, -1)), (l = !0))),
                    mr(t, r, s, i, a, l, c, e[n]));
                }
              else
                (pr(t, r, JSON.stringify(i), e[n]),
                  !t.component &&
                    "muted" === r &&
                    Ki(t.tag, t.attrsMap.type, r) &&
                    dr(t, r, "true", e[n]));
          })(t),
          t
        );
      ...
      function Gi(t) {
        ...
        if ((e = _r(t, "v-for"))) {
          const n = (function (t) {
            ...
            const n = {};
            n.for = e[2].trim();
            const o = e[1].trim().replace(ji, ""),
              r = o.match(Ai);
            r
              ? ((n.alias = o.replace(Ai, "").trim()),
        ...
        ni,
        {
          preTransformNode: function (t, e) {
            if ("input" === t.tag) {
              ...
              let o;
              if (
                ((n[":type"] || n["v-bind:type"]) && (o = yr(t, "type")),
                n.type || o || !n["v-bind"] || (o = `(${n["v-bind"]}).type`),
                o)
              ) {
                const n = _r(t, "v-if", !0),
                  r = n ? `&&(${n})` : "",
                  s = null != _r(t, "v-else", !0),
                  i = _r(t, "v-else-if", !0),
                  c = oc(t);
                (Gi(c),
                  hr(c, "type", "checkbox"),
                  ...
                  (c.processed = !0),
                  (c.if = `(${o})==='checkbox'` + r),
                  Xi(c, { exp: c.if, block: c }));
                const a = oc(t);
                (_r(a, "v-for", !0),
                  hr(a, "type", "radio"),
                  Zi(a, e),
                  Xi(c, { exp: `(${o})==='radio'` + r, block: a }));
                const l = oc(t);
                return (
                  _r(l, "v-for", !0),
                  hr(l, ":type", o),
        ...
        directives: {
          model: function (t, e, n) {
            const o = e.value,
              ...
              s = t.tag,
              i = t.attrsMap.type;
            if (t.component) return (wr(t, o, r), !1);
            if ("select" === s)
              !(function (t, e, n) {
                const o = n && n.number;
              ...
              !(function (t, e, n) {
                ...
                (dr(
                  ...
                  vr(
                    t,
                    "change",
                    `var $$a=${e},$$el=$event.target,$$c=$$el.checked?(${s}):(${i});if(Array.isArray($$a)){var $$v=${o ? "_n(" + r + ")" : r},$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(${xr(e, "$$a.concat([$$v])")})}else{$$i>-1&&(${xr(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))")})}}else{${xr(e, "$$c")}}`,
                    null,
                    !0,
                  ));
              })(t, o, r);
              ...
              !(function (t, e, n) {
                const o = n && n.number;
                let r = yr(t, "value") || "null";
                ((r = o ? `_n(${r})` : r),
                  dr(t, "checked", `_q(${e},${r})`),
                  vr(t, "change", xr(e, r), null, !0));
              })(t, o, r);
              ...
              !(function (t, e, n) {
                ...
                (dr(t, "value", `(${e})`),
                  vr(t, a, u, null, !0),
                  (i || s) && vr(t, "blur", "$forceUpdate()"));
              })(t, o, r);
            else if (!F.isReservedTag(s)) return (wr(t, o, r), !1);
            return !0;
          },
          text: function (t, e) {
        ...
        if (1 === t.type) {
          ...
          if (((t.staticRoot = !1), t.children))
            for (let n = 0, o = t.children.length; n < o; n++)
              fc(t.children[n], e || !!t.for);
          if (t.ifConditions)
            for (let n = 1, o = t.ifConditions.length; n < o; n++)
              fc(t.ifConditions[n].block, e);
        }
      }
      ...
      function _c(t, e) {
        ...
        return (
          (o = `{${o.slice(0, -1)}}`),
          r ? n + `_d(${o},[${r.slice(0, -1)}])` : n + o
        );
      }
      function $c(t) {
        if (!t) return "function(){}";
        if (Array.isArray(t)) return `[${t.map((t) => $c(t)).join(",")}]`;
        const e = hc.test(t.value),
          n = dc.test(t.value),
          o = hc.test(t.value.replace(pc, ""));
        if (t.modifiers) {
          let r = "",
            s = "";
          const i = [];
          for (const e in t.modifiers)
            if (yc[e]) ((s += yc[e]), mc[e] && i.push(e));
            else if ("exact" === e) {
              const e = t.modifiers;
              s += vc(
                ["ctrl", "shift", "alt", "meta"]
          ...
          (i.length &&
            (r += (function (t) {
              return `if(!$event.type.indexOf('key')&&${t.map(bc).join("&&")})return null;`;
            })(i)),
            s && (r += s));
      ...
      var wc = {
        ...
        bind: function (t, e) {
          t.wrapData = (n) =>
            `_b(${n},'${t.tag}',${e.value},${e.modifiers && e.modifiers.prop ? "true" : "false"}${e.modifiers && e.modifiers.sync ? ",true" : ""})`;
        },
        cloak: j,
      };
      class xc {
        constructor(t) {
          ((this.options = t),
            ...
            (this.directives = T(T({}, wc), t.directives)));
      ...
      function Cc(t, e) {
        const n = new xc(e);
        return {
          render: `with(this){return ${t ? ("script" === t.tag ? "null" : kc(t, n)) : '_c("div")'}}`,
      ...
      function kc(t, e) {
        if (
          ...
          return Oc(t, e);
        if (t.once && !t.onceProcessed) return Tc(t, e);
        if (t.for && !t.forProcessed) return Ec(t, e);
        if (t.if && !t.ifProcessed) return Ac(t, e);
        if ("template" !== t.tag || t.slotTarget || e.pre) {
            ...
            })(t, e);
          {
            ...
            if (t.component)
              n = (function (t, e, n) {
                const o = e.inlineTemplate ? null : Pc(e, n, !0);
                return `_c(${t},${Nc(e, n)}${o ? `,${o}` : ""})`;
              })(t.component, t, e);
            else {
              let o, r;
              (!t.plain || (t.pre && e.maybeComponent(t))) && (o = Nc(t, e));
              const s = e.options.bindings;
              (s &&
                !1 !== s.__isScriptSetup &&
                (r = Sc(s, t.tag) || Sc(s, w(t.tag)) || Sc(s, x(w(t.tag)))),
                r || (r = `'${t.tag}'`));
              const i = t.inlineTemplate ? null : Pc(t, e, !0);
              n = `_c(${r}${o ? `,${o}` : ""}${i ? `,${i}` : ""})`;
            }
      ...
      function Oc(t, e) {
        ...
        return (
          t.pre && (e.pre = t.pre),
          e.staticRenderFns.push(`with(this){return ${kc(t, e)}}`),
          (e.pre = n),
          `_m(${e.staticRenderFns.length - 1}${t.staticInFor ? ",true" : ""})`
        );
      }
      function Tc(t, e) {
        if (((t.onceProcessed = !0), t.if && !t.ifProcessed)) return Ac(t, e);
        if (t.staticInFor) {
          let n = "",
            o = t.parent;
          for (; o; ) {
          ...
          return n ? `_o(${kc(t, e)},${e.onceId++},${n})` : kc(t, e);
        }
        return Oc(t, e);
      }
      function Ac(t, e, n, o) {
        return ((t.ifProcessed = !0), jc(t.ifConditions.slice(), e, n, o));
      }
      function jc(t, e, n, o) {
        if (!t.length) return o || "_e()";
        const r = t.shift();
        return r.exp
          ? `(${r.exp})?${s(r.block)}:${jc(t, e, n, o)}`
          : `${s(r.block)}`;
        function s(t) {
          return n ? n(t, e) : t.once ? Tc(t, e) : kc(t, e);
        }
      }
      function Ec(t, e, n, o) {
        const r = t.for,
        ...
        return (
          (t.forProcessed = !0),
          `${o || "_l"}((${r}),function(${s}${i}${c}){return ${(n || kc)(t, e)}})`
        );
      }
      function Nc(t, e) {
        let n = "{";
        ...
        if (
          (t.attrs && (n += `attrs:${Lc(t.attrs)},`),
          t.props && (n += `domProps:${Lc(t.props)},`),
          t.events && (n += `${_c(t.events, !1)},`),
          t.nativeEvents && (n += `${_c(t.nativeEvents, !0)},`),
        ...
        return (
          (n = n.replace(/,$/, "") + "}"),
          t.dynamicAttrs && (n = `_b(${n},"${t.tag}",${Lc(t.dynamicAttrs)})`),
      ...
      function Mc(t, e) {
        ...
        if (t.if && !t.ifProcessed && !n) return Ac(t, e, Mc, "null");
        if (t.for && !t.forProcessed) return Ec(t, e, Mc);
        const o = "_empty_" === t.slotScope ? "" : String(t.slotScope),
          r = `function(${o}){return ${"template" === t.tag ? (t.if && n ? `(${t.if})?${Pc(t, e) || "undefined"}:undefined` : Pc(t, e) || "undefined") : kc(t, e)}}`,
          s = o ? "" : ",proxy:true";
        return `{key:${t.slotTarget || '"default"'},fn:${r}${s}}`;
      }
      function Pc(t, e, n, o, r) {
        const s = t.children;
        if (s.length) {
          const t = s[0];
          if (
                  ...
                  for (let o = 0; o < t.length; o++) {
                    ...
                    if (1 === r.type) {
                      if (
                        Ic(r) ||
                        (r.ifConditions &&
                          r.ifConditions.some((t) => Ic(t.block)))
                      ) {
                        n = 2;
                        break;
                      }
      ...
      function Rc(t, e) {
        return 1 === t.type
          ...
          : 3 === t.type && t.isComment
            ...
            : (function (t) {
                return `_v(${2 === t.type ? t.expression : Fc(JSON.stringify(t.text))})`;
              })(t);
      }
      function Lc(t) {
        let e = "",
      ...
      function Bc(t) {
        ...
        return function (n, o, r) {
          ...
          const i = t(n, o),
            ...
            a = [];
          return (
            (c.render = Hc(i.render, a)),
            (c.staticRenderFns = i.staticRenderFns.map((t) => Hc(t, a))),
            (e[s] = c)
          );
        };
      }
      ...
      const Uc =
        ...
        function (t) {
          ...
          return { compile: e, compileToFunctions: Bc(e) };
        });
      var zc;
      const { compile: Vc, compileToFunctions: Kc } = Uc(sc);
      let Jc;
      function qc(t) {
        return (
          (Jc = Jc || document.createElement("div")),
          (Jc.innerHTML = t ? '<a href="\n"/>' : '<div a="\n"/>'),
      ...
      const Wc = !!K && qc(!1),
        ...
        Xc = lo.prototype.$mount;
      ((lo.prototype.$mount = function (t, e) {
        if (
          (t = t && Fo(t)) === document.body ||
        ...
        if (!n.render) {
          let e = n.template;
          if (e)
            if ("string" == typeof e) "#" === e.charAt(0) && (e = Gc(e));
            else {
          ...
          if (e) {
            const { render: t, staticRenderFns: o } = Kc(
              e,
              {
                outputSourceRange: !1,
        ...
        (lo.compile = Kc),
        T(lo, Cn),
        (lo.effect = function (t, e) {
          const n = new An(it, t, j, { sync: !0 });
          e &&
            (n.update = () => {
              e(() => n.run());
            });
  ...
  !(function () {
    ...
    var vue_common_prod_default =
      /*#__PURE__*/ __webpack_require__.n(vue_common_prod); // CONCATENATED MODULE: ./lib/view/assets-development/javascript/utils/event-bus.js
    /* harmony default export */ var event_bus =
      new (vue_common_prod_default())(); // CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=template&id=727e58b0&
    ...
    var staticRenderFns = [];
    render._withStripped = true; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=template&id=727e58b0&
    ...
    foldervue_type_template_id_ceb1e49c_render._withStripped = true; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/archive/folder.vue?vue&type=template&id=ceb1e49c&
    ...
    /* harmony default export */ var archive_foldervue_type_script_lang_js_ =
      foldervue_type_script_lang_js_; // CONCATENATED MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
    ...
    /* harmony default export */ var folder = component.exports; // CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./lib/view/assets-development/javascript/vue-components/progress-bar.vue?vue&type=template&id=8b61c75e&
    ...
    progress_barvue_type_template_id_8b61c75e_render._withStripped = true; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/progress-bar.vue?vue&type=template&id=8b61c75e&
    ...
    /* harmony default export */ var vue_components_progress_barvue_type_script_lang_js_ =
      progress_barvue_type_script_lang_js_; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/progress-bar.vue
    /* normalize component */
    ...
    /* harmony default export */ var progress_bar =
      progress_bar_component.exports; // CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./lib/view/assets-development/javascript/vue-components/ai1wm-spinner.vue?vue&type=template&id=62088451&
    var vsc_backup_spinnervue_type_template_id_62088451_render = function render() {
      var _vm = this,
        _c = _vm._self._c;
    ...
    var vsc_backup_spinnervue_type_template_id_62088451_staticRenderFns = [
      function () {
        var _vm = this,
          _c = _vm._self._c;
    ...
    vsc_backup_spinnervue_type_template_id_62088451_render._withStripped = true; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/ai1wm-spinner.vue?vue&type=template&id=62088451&
    ...
    /* harmony default export */ var vsc_backup_spinnervue_type_script_lang_js_ = {}; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/ai1wm-spinner.vue?vue&type=script&lang=js&
    /* harmony default export */ var vue_components_vsc_backup_spinnervue_type_script_lang_js_ =
      vsc_backup_spinnervue_type_script_lang_js_; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/ai1wm-spinner.vue
    /* normalize component */
    var vsc_backup_spinner_component = normalizeComponent(
      vue_components_vsc_backup_spinnervue_type_script_lang_js_,
      vsc_backup_spinnervue_type_template_id_62088451_render,
      vsc_backup_spinnervue_type_template_id_62088451_staticRenderFns,
      false,
      null,
      null,
      null,
    ...
    /* harmony default export */ var vsc_backup_spinner =
      vsc_backup_spinner_component.exports;
    // EXTERNAL MODULE: ./node_modules/file-saver/dist/FileSaver.min.js
    var FileSaver_min = __webpack_require__(162); // CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=script&lang=js&
    ...
    /* harmony default export */ var browservue_type_script_lang_js_ = {
      components: {
        Ai1wmSpinner: vsc_backup_spinner,
      ...
      methods: {
        listContent: function listContent(archive) {
          ...
          _this.processed = 0;
          $.ajax({
            url: vsc_backup_list.ajax.url,
            type: "POST",
            dataType: "json",
            data: {
              secret_key: vsc_backup_list.secret_key,
              archive: archive,
            },
          })
            .done(function (data) {
        ...
        downloadFile: function downloadFile(file) {
          ...
          request.addEventListener("readystatechange", function () {
            if (request.readyState === 2 && request.status === 200) {
              ...
              if (request.status < 400) {
                (0, FileSaver_min.saveAs)(
                  request.response,
                  Ai1wm.Util.basename(file.name),
                );
              } else {
                /* eslint-disable no-alert */
                alert(vsc_backup_locale.archive_browser_download_error);
          ...
          request.open("post", vsc_backup_list.download.url);
        ...
        __: function __(key) {
          return vsc_backup_locale[key];
        },
      },
    }; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/archive/browser.vue?vue&type=script&lang=js&
    /* harmony default export */ var archive_browservue_type_script_lang_js_ =
      browservue_type_script_lang_js_; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/vue-components/archive/browser.vue
    /* normalize component */
    ...
    /* harmony default export */ var browser = browser_component.exports; // CONCATENATED MODULE: ./lib/view/assets-development/javascript/backups.js
    /**
     * Copyright (C) 2014-2020 ServMask Inc.
     *
     * This program is free software: you can redistribute it and/or modify
    ...
    jQuery(document).ready(function ($) {
      ...
      $("#ai1wm-backups-list").on(
        ...
        function (e) {
          ...
          if (confirm(vsc_backup_locale.want_to_delete_this_file)) {
            /* eslint-enable no-alert */
            $.ajax({
              url: vsc_backup_backups.ajax.url,
              type: "POST",
              dataType: "json",
              data: {
                secret_key: vsc_backup_backups.secret_key,
              ...
              if (data.errors.length === 0) {
                ...
                if (counter.text() > 1) {
                  counter.prop(
                    "title",
                    vsc_backup_locale.backups_count_plural.replace(
                      "%d",
                      counter.text(),
                    ),
                  );
                  ...
                  counter.prop(
                    "title",
                    vsc_backup_locale.backups_count_singular.replace(
                      "%d",
                      counter.text(),
                    ),
                  );
      ...
      $("#ai1wm-backups-list").on(
        ...
        function (e) {
          ...
          if (Ai1wm.MultisiteExtensionRestore) {
            var restore = new Ai1wm.MultisiteExtensionRestore(
              $(this).data("archive"),
              $(this).data("size"),
            );
          } else if (Ai1wm.UnlimitedExtensionRestore) {
            var _restore = new Ai1wm.UnlimitedExtensionRestore(
              $(this).data("archive"),
              $(this).data("size"),
            );
          } else if (Ai1wm.FreeExtensionRestore) {
            var _restore2 = new Ai1wm.FreeExtensionRestore(
              $(this).data("archive"),
              $(this).data("size"),
            );
          } else {
            var _restore3 = new Ai1wm.Restore(
              $(this).data("archive"),
              $(this).data("size"),
            );
          }
      ...
      $("#ai1wm-backups-list").on(
        "click",
        ".ai1wm-backup-label-description, .ai1wm-backup-label-text",
        function () {
          $(this).hide();
          $(this)
            .closest(".ai1wm-column-name")
            .find(".ai1wm-backup-label-holder")
            .show();
          $(this)
            .closest(".ai1wm-column-name")
            .find(".ai1wm-backup-label-field")
            .trigger("focus");
        },
      );
      $("#ai1wm-backups-list").on(
        "keydown",
        ".ai1wm-backup-label-field",
        function (e) {
          var self = $(this);
          ...
          if (e.which === 13) {
            ...
            $.ajax({
              url: vsc_backup_backups.labels.url,
              type: "POST",
              dataType: "json",
              data: {
                secret_key: vsc_backup_backups.secret_key,
              ...
              if (data.errors.length === 0) {
                ...
                if (self.val()) {
                  ...
                  self
                    .closest(".ai1wm-column-name")
                    .find(".ai1wm-backup-label-text")
                    .show();
                  self
                    .closest(".ai1wm-column-name")
                    .find(".ai1wm-backup-label-colored")
                    .text(self.val());
                } else {
                  self.closest(".ai1wm-backup-label-holder").hide();
                  self
                    .closest(".ai1wm-column-name")
                    .find(".ai1wm-backup-label-description")
                    .removeClass("ai1wm-backup-label-selected")
                    .removeAttr("style");
                }
      ...
      $(document).on("ai1wm-export-status", function (e, params) {
        if (params.type === "download") {
          ...
          $.get(vsc_backup_backups.backups.url, {
            secret_key: vsc_backup_backups.secret_key,
          }).done(function (data) {
            $("#ai1wm-backups-create").find(".ai1wm-backups-empty").hide();
            $("#ai1wm-backups-create")
              .find(".ai1wm-backups-empty-spinner-holder")
              .hide();
    ...
    __webpack_require__.g.Ai1wm = jQuery.extend(
      {},
      __webpack_require__.g.Ai1wm,
      {
        Feedback: Feedback,
        Import: Import,
        Restore: Restore,
