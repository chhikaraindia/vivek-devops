    ...
    $(".ai1wm-purchase-add").on("click", function (e) {
      ...
      $.ajax({
        ...
        .done(function (product) {
          // Update Purchase ID
          $.ajax({
            url: vsc_backup_updater.ajax.url,
            type: "POST",
            dataType: "json",
            data: {
              ai1wm_uuid: product.uuid,
              vsc_backup_extension: product.extension,
            },
            dataFilter: function dataFilter(data) {
              return Ai1wm.Util.json(data);
            },
            ...
            $("#ai1wm-update-section-" + index).html(
              $("<a />")
                .attr("href", updateLink)
                .text(vsc_backup_locale.check_for_updates),
            );
        ...
        .fail(function () {
          self.attr("disabled", false);
          error.html(vsc_backup_locale.invalid_purchase_id);
        });
      e.preventDefault();
    });
