    ...
    /***/ 814: /***/ function (
      ...
      FileUploader.prototype.init = function () {
        ...
        selectElement.on("change", function (e) {
          ...
          if (file) {
            ...
            if (_this.fileSize > vsc_backup_uploader.max_file_size) {
              _this.model.setStatus({
                type: "pro",
                message: vsc_backup_locale.import_from_file,
              });
            } else {
      ...
      FileUploader.prototype.c1 = function (file) {
        if (file.name.substr(-6) !== "wpress") {
          throw new Error(vsc_backup_locale.invalid_archive_extension);
        }
      }; // Check compatibility

      FileUploader.prototype.c3 = function () {
        if (vsc_backup_compatibility.messages.length > 0) {
          throw new Error(vsc_backup_compatibility.messages.join());
        }
      };
      ...
      FileUploader.prototype.onBeforeUpload = function (file) {
        ...
        var options = Ai1wm.Util.form("#ai1wm-import-form")
          .concat({
            name: "storage",
            value: storage,
          })
        ...
        $.extend(vsc_backup_uploader.params, {
          storage: storage,
          archive: file.name,
        }); // Set stop
      ...
      FileUploader.prototype.upload = function (file) {
        ...
        for (var name in vsc_backup_uploader.params) {
          formData.append(name, vsc_backup_uploader.params[name]);
        }

        $.ajax({
          url: vsc_backup_uploader.url,
          type: "POST",
          data: formData,
          cache: false,
          contentType: false,
