/******/ (function () {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 813: /***/ function () {
       ...
       */
      (function ($) {
        $.fn.vsc_backup_find_replace = function () {
    ...
    /***/ 88: /***/ function () {
      ...
      (function ($) {
        $.fn.vsc_backup_query = function () {
          ...
          findInput.on(
            "change paste input keypress keydown keyup",
            function () {
              var _inputValue =
                $(this).val().length > 0 ? $(this).val() : "<text>";
          ...
          replaceInput.on(
            ...
            function () {
              var _inputValue =
                $(this).val().length > 0 ? $(this).val() : "<another-text>";
  ...
  !(function () {
    ...
    jQuery(document).ready(function ($) {
      ...
      $("#ai1wm-export-file").on("click", function (e) {
        if ($("#ai1wm-encrypt-backups").is(":checked")) {
          ...
          var passwordConfirmationInput = $(
            "#ai1wm-backup-encrypt-password-confirmation",
          );
      ...
      $("#ai1wm-add-new-replace-button").vsc_backup_find_replace();
      $(
        ".ai1wm-expandable > p:first, .ai1wm-expandable > h4:first, .ai1wm-expandable > div.ai1wm-button-main",
      ).on("click", function () {
        $(this).parent().toggleClass("ai1wm-open");
      });
      $(".ai1wm-query").vsc_backup_query();
