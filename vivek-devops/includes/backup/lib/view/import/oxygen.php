...
if ( $should_reset_permalinks ) {
	_e(
		'» Permalinks are set to default. <a class="ai1wm-no-underline" href="https://help.vivekchhikara.com/knowledgebase/permalinks-are-set-to-default/" target="_blank">Why?</a> (opens a new window)<br />' .
		...
		'» <a class="ai1wm-no-underline" href="https://wordpress.org/support/view/plugin-reviews/vsc-backup?rate=5#postform" target="_blank">Optionally, review the plugin</a>. (opens a new window)',
